...
public class ContractUtil {
 	 ...
 	 * 注:业务代码处必须传指定对象的id
 	 */
	public static List<Element> putContentToElements(SignElement signElement,SlSmallloanProject project,CreditBaseDao util,
			String filePath,Map<String,Object> idMap,String businessType,int contractId){
 		try{
 			Object obj=null;
 			String flag="";//临时标识
