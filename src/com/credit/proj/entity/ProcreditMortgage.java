...
public class ProcreditMortgage implements java.io.Serializable {
	...
	private BigDecimal finalCertificationPriceMax;//最终认证价格2
	
	private BigDecimal depreciationPrice;//折旧价
	
	private Long productId;//产品Id
	private String guaranteeType;//担保类型
	private Integer isGPS;// 0 否 1是  安装GPS
	private BigDecimal carNumberMoney;//车牌价格
	//end
	/** default constructor */
	...
	public ProcreditMortgage(Integer assuretypeid, Integer assuremodeid,
			...
			Date valuationTime,String mortgageRemarks,Boolean isRecieve,Date recieveDate,String recieveRemarks,Date createTime,
			Date unchainCreateTime,Date tractCreateTime,BigDecimal finalCertificationPrice,
			BigDecimal finalCertificationPriceMax,Integer isGPS,BigDecimal carNumberMoney) {
		...
		this.finalCertificationPriceMax=finalCertificationPriceMax;
		this.isGPS=isGPS;
		this.carNumberMoney=carNumberMoney;
	}
	...
	public BigDecimal getFinalCertificationPriceMax() {
		return finalCertificationPriceMax;
	}

	public void setFinalCertificationPriceMax(BigDecimal finalCertificationPriceMax) {
		this.finalCertificationPriceMax = finalCertificationPriceMax;
	}

	public BigDecimal getCarNumberMoney() {
		return carNumberMoney;
	}

	public void setCarNumberMoney(BigDecimal carNumberMoney) {
		this.carNumberMoney = carNumberMoney;
	}
