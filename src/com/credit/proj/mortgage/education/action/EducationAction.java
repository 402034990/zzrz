package com.credit.proj.mortgage.education.action;
...
public class EducationAction extends CreditBaseAction {
	...
	private VProjMortEducation vProjMortEducation;
	...
	public void addEducation() {
		try {
			...
			procreditMortgage.setMortgagenametypeid(pageconfig.EducationID);
			...
			procreditMortgage.setMortgagepersontypeforvalue(pageconfig.EducationValue);
	...
	public void seeEducationForUpdate() throws Exception{
		...
		List list=educationService.seeEducation(rid);
		if(null!=list && list.size()!=0){
			vProjMortEducation=(VProjMortEducation)list.get(0);
			...
			mapObject.put("vProjMortEducation", vProjMortEducation);
	...
	public void updateEducation(){
		...
		try {
			educationService.updateEducation(mortgageid,procreditMortgageEducation,procreditMortgage);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public VProjMortEducation getvProjMortEducation() {
		return vProjMortEducation;
	}

	public void setvProjMortEducation(VProjMortEducation vProjMortEducation) {
		this.vProjMortEducation = vProjMortEducation;
	}
