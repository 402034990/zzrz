...
public interface MortgageService {
	...
	//抵质押物管理(新的方法，为了区分车辆相关和其他类型抵质押物)
	public List getMortgageList(String businessType,String mortgagename,String projectName,String projectNum,String mortgageType,String danbaoType,String minMoney,String maxMoney,int start,int limit,int status,String mortgageStatus,String companyId,String type);
	...
	public VProcreditDictionary getVProcreditDictionaryByMortgageId(String mortgageId);
	/**
	...
	public ProcreditMortgage getProjectId(Long project,String businessType,String mortgageId);
	/**
	 * 查询车辆数据信息
	 * @param businessType
	 * @param status
	 ...
	 * @return
	 */
	public  List<ProcreditMortgageCar> getCarData(String projectNum,String  projectName ,String mortgageName,String danbaoType,String minMoney, String maxMoney,int status,int start,int limit);
	/**
	 * 根据项目id查询车辆抵质押物的信息，生成到合同里面去
	 * @param businessType
	 * @param status
	 * @param start
	 * @param limit
