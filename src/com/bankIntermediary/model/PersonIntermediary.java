...
public class PersonIntermediary extends BaseModel  implements  java.io.Serializable {
	
	
	public String  loginname;//登陆名
	public String password;//登陆密码
	public String plainpassword;//推荐码
	public String  socialSecurityNumber;//社保卡号
	public java.math.BigDecimal   socialSecurityDepositBase;//社保缴存基数
	public String  socialSecurityConTimeDeposit;//连续缴存时间
	public  String providentFundCardNumber;//公积金卡号
	public  java.math.BigDecimal   providentFundDepositBase;// 公积金缴存基数
	public  String providentFundConTimeDeposit;//公积金连续缴存时间
	public Short isPolicy;//是否有保单 0 否 1 是
	public String  trueName;//真实姓名
	public  Long sourceId;//客户来源主键
	public  String sourceName;//客户来源名称
	public  String customerLabel;//客户标签
	public  Short  state;//状态  0 已删除客户 1 意向客户 2 正式客户
	public Short isFlag;//是否被标记 0 否 1 是
	public Short flagId;//标记id
	public String flagName;//标记名称
	public String  result;//原因说明
	public String  biRecommendCode;//邀请码
	public Short  isMerge;//是否被合并
	public  Long mergePersonId;//被合并人的id
	public  Long  followPersonId;//当前跟进人的主键
	public String  followPersonName;//当前跟进人的姓名
	public Long distributionPersonId;//分配人的id
	public String distributionPersonName ;//分配人的姓名
	public java.util.Date distributionPersonTime;//分配时间
	public java.util.Date  lastFollowTime;//最后跟时间
	public Integer  followNums;//跟进次数
	
	
	public String hangyeName;//行业类别说明
	private Integer hangyeType;//行业类别id
	...
	private String personNumber;//客户编号
	private Integer id;
	...
	private BigDecimal banKCreditMoney;//信用金额字段
	...
	// Constructors
//	PersonIntermediary
	protected Set<BpCustPersonNegativeSurveyIntermediary1> negativeInfos = new HashSet<BpCustPersonNegativeSurveyIntermediary1>();
	protected Set<BpCustPersonEducationIntermediary> educationInfos = new HashSet<BpCustPersonEducationIntermediary>();
	protected Set<BpCustPersonPublicActivityIntermediary> activityInfos = new HashSet<BpCustPersonPublicActivityIntermediary>();
	protected Set<BpCustPersonWorkExperienceIntermediary> workExperienceInfos = new HashSet<BpCustPersonWorkExperienceIntermediary>();
	protected Set<CsPersonCarIntermediary> personCars = new HashSet<CsPersonCarIntermediary>();
	protected Set<CsPersonHouseIntermediary> personHouses = new HashSet<CsPersonHouseIntermediary>();
	...
	public java.math.BigDecimal getSocialSecurityDepositBase() {
		return socialSecurityDepositBase;
	}

	public void setSocialSecurityDepositBase(
			java.math.BigDecimal socialSecurityDepositBase) {
		this.socialSecurityDepositBase = socialSecurityDepositBase;
	}

	public String getSocialSecurityConTimeDeposit() {
		return socialSecurityConTimeDeposit;
	}

	public void setSocialSecurityConTimeDeposit(String socialSecurityConTimeDeposit) {
		this.socialSecurityConTimeDeposit = socialSecurityConTimeDeposit;
	}

	public String getProvidentFundCardNumber() {
		return providentFundCardNumber;
	}

	public void setProvidentFundCardNumber(String providentFundCardNumber) {
		this.providentFundCardNumber = providentFundCardNumber;
	}

	public java.math.BigDecimal getProvidentFundDepositBase() {
		return providentFundDepositBase;
	}

	public void setProvidentFundDepositBase(
			java.math.BigDecimal providentFundDepositBase) {
		this.providentFundDepositBase = providentFundDepositBase;
	}

	public String getProvidentFundConTimeDeposit() {
		return providentFundConTimeDeposit;
	}

	public void setProvidentFundConTimeDeposit(String providentFundConTimeDeposit) {
		this.providentFundConTimeDeposit = providentFundConTimeDeposit;
	}

	public Short getIsPolicy() {
		return isPolicy;
	}

	public void setIsPolicy(Short isPolicy) {
	...
	public String getBiRecommendCode() {
		return biRecommendCode;
	}

	public void setBiRecommendCode(String biRecommendCode) {
		this.biRecommendCode = biRecommendCode;
	}

	public Short getIsMerge() {
		return isMerge;
	}

	public void setIsMerge(Short isMerge) {
		this.isMerge = isMerge;
	}

	public Long getMergePersonId() {
		return mergePersonId;
	}

	public void setMergePersonId(Long mergePersonId) {
	...
	public java.util.Date getDistributionPersonTime() {
		return distributionPersonTime;
	}

	public void setDistributionPersonTime(java.util.Date distributionPersonTime) {
		this.distributionPersonTime = distributionPersonTime;
	}
	...
	public BigDecimal getBanKCreditMoney() {
		return banKCreditMoney;
	}

	public void setBanKCreditMoney(BigDecimal banKCreditMoney) {
		this.banKCreditMoney = banKCreditMoney;
	}
	...
	/** default constructor */
	public PersonIntermediary() {
	}
	
	public PersonIntermediary(Integer id, Integer mateid, String name, Integer sex,
	...
	public PersonIntermediary(Integer aValue){
		this.setId(aValue);
	}
	...
	public Set<BpCustPersonNegativeSurveyIntermediary1> getNegativeInfos() {
		return negativeInfos;
	}

	public void setNegativeInfos(Set<BpCustPersonNegativeSurveyIntermediary1> negativeInfos) {
		this.negativeInfos = negativeInfos;
	}

	public Set<BpCustPersonEducationIntermediary> getEducationInfos() {
		return educationInfos;
	}

	public void setEducationInfos(Set<BpCustPersonEducationIntermediary> educationInfos) {
		this.educationInfos = educationInfos;
	}

	public Set<BpCustPersonPublicActivityIntermediary> getActivityInfos() {
		return activityInfos;
	}

	public void setActivityInfos(Set<BpCustPersonPublicActivityIntermediary> activityInfos) {
		this.activityInfos = activityInfos;
	}

	public Set<BpCustPersonWorkExperienceIntermediary> getWorkExperienceInfos() {
		return workExperienceInfos;
	}

	public void setWorkExperienceInfos(
			Set<BpCustPersonWorkExperienceIntermediary> workExperienceInfos) {
		this.workExperienceInfos = workExperienceInfos;
	}

	public Set<CsPersonCarIntermediary> getPersonCars() {
		return personCars;
	}

	public void setPersonCars(Set<CsPersonCarIntermediary> personCars) {
		this.personCars = personCars;
	}

	public Set<CsPersonHouseIntermediary> getPersonHouses() {
		return personHouses;
	}

	public void setPersonHouses(Set<CsPersonHouseIntermediary> personHouses) {
