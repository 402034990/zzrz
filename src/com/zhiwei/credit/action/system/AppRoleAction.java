...
public class AppRoleAction extends BaseAction {
	...
	public String exitExcel() {
		...
		try {
			roleNames = new String(roleNames.getBytes("ISO-8859-1"),"utf-8");
	...
	private String getParentStr(Element e, String rights, Long orgId) {
		...
		if (sub) {
			...
			//by shang
			if(PStrV.contains("Mod_")&&!PStrV.equals(PStrR)){
				...
				listStr=PStrV+","+e.getParent().attributeValue("text")+","+pistrue;
