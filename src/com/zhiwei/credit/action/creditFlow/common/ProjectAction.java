...
/*		if(null==project.getIntentDate()||"".equals(project.getIntentDate())){
	...
	public String getCreditLoanProjectInfo(){
		...
		try{
		 ...
		 if(null!=project.getBankId()){
	         ...
	         EnterpriseBank bank=enterpriseBankService.getById(Integer.valueOf(project.getBankId().toString()));
	         if(null!=bank){
	        	 map.put("enterpriseBank", bank);
	         }
		 }
	...
	public String getAllInfo(){		
		...
		SlSmallloanProject project=this.slSmallloanProjectService.get(Long.valueOf(fundProjectId));
		...
		List<PlProjectArchives> archives=plProjectArchivesService.getbyproject(project.getProjectId(),"SmallLoan");
	...
	*/}
	...
	public String end() {
		...
		creditProjectService.updateProcessRunStatus(taskId,Long.valueOf(runId),projectId,businessType,comments);
		return SUCCESS;
	}
