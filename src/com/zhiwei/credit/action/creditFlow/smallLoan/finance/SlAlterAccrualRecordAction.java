...
//利率变更流程loaddata方法
	public String getInfoLoaned(){
		...
		try{
			...
			if(null!=slAlterAccrualRecord.getProjectId() && !"".equals(slAlterAccrualRecord.getProjectId())){
				BpFundProject ownBpFundProject=bpFundProjectService.get(slAlterAccrualRecord.getProjectId());
