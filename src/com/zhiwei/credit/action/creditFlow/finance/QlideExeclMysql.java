		    				 ...
		    				 if(null == cell){
		    					 ...
		    					 if(cell.getCellType()==HSSFCell.CELL_TYPE_STRING ){
		    						 ...
		    						 if(j==2){
		    							 ...
		    							 if(flag==0){return "第"+(i+1)+"行,我方账户填写有误";}
		    						 }
			            			...
			            			else if(j==2 || j==9 ){boolean c=true; c=testaccount(str[j].trim());if(c==false)return "第"+(i+1)+"行,"+(j+1)+"列格式不对";}
