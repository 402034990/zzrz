...
public class PlBidCompensatoryAction extends BaseAction{
	...
	public String display(){
		PageBean<SlFundIntent> pageBean = new PageBean<SlFundIntent>(0, 7,this.getRequest());
		Map<String, String> map = new HashMap<String, String>();
		map.put("businessType", "SmallLoan");
		map.put("tabflag", "overdue");
		map.put("Q_intentType_SN_EQ", "0");
		...
		slFundIntentService.searchurge(pageBean, map, "SmallLoan");
		getRequest().setAttribute("overDuePlanList",pageBean.getResult());
		return "display";
	}
}
