...
public class RelativeUserDaoImpl extends BaseDaoImpl<RelativeUser> implements
	...
	@Override
	public RelativeUser findSuperiorId(Long userId) {
		String hql = "from RelativeUser as r where r.appUser.userId = ? and r.isSuper = 1";
		Object[] params = {userId};
		return (RelativeUser)findUnique(hql, params);
	}
}