...
public class SlProcreditMaterialsDaoImpl extends BaseDaoImpl<SlProcreditMaterials> implements SlProcreditMaterialsDao{
	...
	public List<SlProcreditMaterials> listByProjIdAndTypeKey(String projId, String typeKey,String mortgageId) {
			String hql = "from SlProcreditMaterials sm where sm.projId=? and typekey=? and mortgageId = ?";
		return this.getSession().createQuery(hql).setParameter(0, projId).setParameter(1, "chengnuohan").setParameter(2, mortgageId).list();
	}
