...
public class CsPersonHouseDaoImpl extends BaseDaoImpl<CsPersonHouse> implements CsPersonHouseDao{
	...
	@Override
	public List<CsPersonHouse> getByPersonId(String personId, Long projectId) {
		String hql=" from CsPersonHouse as house where house.person.id="+personId+" and house.projectId="+projectId;
		List<CsPersonHouse> list=findByHql(hql);
		return list;
	}
