...
public class CreditRecordDaoImpl extends BaseDaoImpl<CreditRecord> implements CreditRecordDao{

	public CreditRecordDaoImpl() {
	...
	public List<CreditRecord> getByProjectIdType(Long projectId, String type) {
		...
		String hql="from CreditRecord as cr where cr.projectId=? and cr.type=?";
