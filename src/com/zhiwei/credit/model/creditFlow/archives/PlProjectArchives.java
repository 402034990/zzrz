...
public class PlProjectArchives extends com.zhiwei.core.model.BaseModel {
	...
	private Short isIntStroage;//是否入库
	private Date inStorageDate;//入库时间
	private String inStorageRemark;//入库备注 
	private  Long  handerId;//办理人主键
	private  String  handerName;//办理人名称
	...
	public Short getIsIntStroage() {
		return isIntStroage;
	}

	public void setIsIntStroage(Short isIntStroage) {
		this.isIntStroage = isIntStroage;
	}
