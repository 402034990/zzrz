...
public class SlSmallloanProject extends BaseProject {
	...
	protected String chargeType;   //手续费收取方式   1:前置  2:后置
	...
	protected Long channelName;//渠道名称
	 ...
	 * 手续费率
	 */
	protected BigDecimal serviceChargeOfRate;
	...
	protected  String  temporaryCarNo; //临时车牌号
	protected  String  yewu;// 业务办理人
	protected  Long  yewuId;// 业务办理人id
	protected  Integer  loanWay; // 贷款方式   0押证 1押车
	protected  String  customerSource; //客户来源
	protected  Integer  isSingle; // s是否转单   1 是 0 否
	protected  Integer   customerType; // 客户类型    1新增  0 结清再贷
	protected  Integer   customerGroups; //客户人群     ['法人',0],['股东',1],['个体',2],['授薪人士',3],['自由职业',4]
	protected  Integer   isShanghai; // 是否出上海    1是  0否
	protected  String    NetworkAudit;// 网审信息 
	protected  String    faceAudit;// 面审
	protected  String    telephoneAudit; // 电审
	protected  Integer   nameNumeber;  // 过审次数
	protected   Integer  violationsNumber;  // 违规次数
	//不与数据库关联
	private Long runId;
	...
	// 睿本客户统计字段 不与数据关联
	public BigDecimal total;// 每种类型的总数
	public BigDecimal refusedPer; // 
	public BigDecimal refusedSer;//
	...
	public BigDecimal getRefusedPer() {
		return refusedPer;
	}
	public void setRefusedPer(BigDecimal refusedPer) {
		this.refusedPer = refusedPer;
	}
	public BigDecimal getRefusedSer() {
		return refusedSer;
	}
	public void setRefusedSer(BigDecimal refusedSer) {
		this.refusedSer = refusedSer;
	}
	//================20160815
	/**
	 * 年模型360,365
	...
	/**
	 * 月模型  1 按月化利率直接计算,2 按日化利率乘以实际天数计算,3 按日化利率乘以固定30天计算
	 */
	public Integer monthModel;
	/**
	 * 还款模型 0 不算头不算尾, 1 算头不算尾, 2 算头又算尾
	 */
	public Integer headTailModel;
	/**
	 * 是否一次性付本 0 否 1 是
	 */
	public Integer isPrincipalByOneTime;
	/**
	 * 利率固定金额
	 */
	public BigDecimal fixedAccrualRate;
	/**
	 * 管理费固定金额
	 */
	public BigDecimal fixedManagementConsultingOfRate;
	/**
	 * 财务费固定金额
	 */
	public BigDecimal fixedFinanceServiceOfRate;
	
	
	
	public BigDecimal getServiceChargeOfRate() {
		return serviceChargeOfRate;
	}
	public void setServiceChargeOfRate(BigDecimal serviceChargeOfRate) {
		this.serviceChargeOfRate = serviceChargeOfRate;
	}
	...
	public String getNetworkAudit() {
		return NetworkAudit;
	}
	public void setNetworkAudit(String networkAudit) {
		this.NetworkAudit = networkAudit;
	}
	public String getFaceAudit() {
		return faceAudit;
	}
	public void setFaceAudit(String faceAudit) {
		this.faceAudit = faceAudit;
	}
	public String getTelephoneAudit() {
		return telephoneAudit;
	}
	public void setTelephoneAudit(String telephoneAudit) {
		this.telephoneAudit = telephoneAudit;
	}
	public Integer getNameNumeber() {
		return nameNumeber;
	}
	public void setNameNumeber(Integer nameNumeber) {
		this.nameNumeber = nameNumeber;
	}
	...
	public String getTemporaryCarNo() {
		return temporaryCarNo;
	}
	public void setTemporaryCarNo(String temporaryCarNo) {
		this.temporaryCarNo = temporaryCarNo;
	}
	...
	public void setCustomerGroups(Integer customerGroups) {
...
*/
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder()
				...
				.append(this.yewuId, rhs.yewuId)
				.append(this.carNo, rhs.carNo)
				.append(this.yewu, rhs.yewu)
				.append(this.teamManagerName, rhs.teamManagerName)
				.append(this.teamManagerId, rhs.teamManagerId)
				.isEquals();
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				...
				.append(this.yewuId)
				.append(this.yewu)
				.append(this.teamManagerId)
				.append(this.teamManagerName)
				.toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this)
			...
			//	.append("oppositeType", this.oppositeType) 
				...
				.append("yewuId",this.yewuId)
				.append("yewu",this.yewu)
				.append("teamManagerId",this.teamManagerId)
				.append("teamManagerName",this.teamManagerName)
	...
	public Integer getMonthModel() {
		return monthModel;
	}
	public void setMonthModel(Integer monthModel) {
		this.monthModel = monthModel;
	}
	public Integer getHeadTailModel() {
		return headTailModel;
	}
	public void setHeadTailModel(Integer headTailModel) {
		this.headTailModel = headTailModel;
	}
	public Integer getIsPrincipalByOneTime() {
		return isPrincipalByOneTime;
	}
	public void setIsPrincipalByOneTime(Integer isPrincipalByOneTime) {
		this.isPrincipalByOneTime = isPrincipalByOneTime;
	}
	public BigDecimal getFixedAccrualRate() {
		return fixedAccrualRate;
	}
	public void setFixedAccrualRate(BigDecimal fixedAccrualRate) {
		this.fixedAccrualRate = fixedAccrualRate;
	}
	public BigDecimal getFixedManagementConsultingOfRate() {
		return fixedManagementConsultingOfRate;
	}
	public void setFixedManagementConsultingOfRate(
			BigDecimal fixedManagementConsultingOfRate) {
		this.fixedManagementConsultingOfRate = fixedManagementConsultingOfRate;
	}
	public BigDecimal getFixedFinanceServiceOfRate() {
		return fixedFinanceServiceOfRate;
	}
	public void setFixedFinanceServiceOfRate(BigDecimal fixedFinanceServiceOfRate) {
		this.fixedFinanceServiceOfRate = fixedFinanceServiceOfRate;
	}
