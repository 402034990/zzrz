...
public class Enterprise extends BaseModel implements  java.io.Serializable {
    ...
    // 睿本新加
    private Integer enterpriseYyzzzId;
    private String enterpriseYyzzzURL;
    private String enterpriseYyzzzExtendName;
    ...
    //睿本新加
    private Integer enterpriseZzzjgId;
    private String enterpriseZzzjgURL;
    private String enterpriseZzzjgExtendName;
    
    private Integer enterpriseDsdjId;
    private String enterpriseDsdjURL;
    private String enterpriseDsdjExtendName;
    
    private Integer enterprisetyjId;
    private String tongyishehuixinyongdaimaURL;
    private String tongyishehuixinyongdaimaExtendName;
	...
	public Integer getEnterpriseZzzjgId() {
		return enterpriseZzzjgId;
	}

	public void setEnterpriseZzzjgId(Integer enterpriseZzzjgId) {
		this.enterpriseZzzjgId = enterpriseZzzjgId;
	}

	public String getEnterpriseZzzjgURL() {
		return enterpriseZzzjgURL;
	}

	public void setEnterpriseZzzjgURL(String enterpriseZzzjgURL) {
		this.enterpriseZzzjgURL = enterpriseZzzjgURL;
	}

	public String getEnterpriseZzzjgExtendName() {
		return enterpriseZzzjgExtendName;
	}

	public void setEnterpriseZzzjgExtendName(String enterpriseZzzjgExtendName) {
		this.enterpriseZzzjgExtendName = enterpriseZzzjgExtendName;
	}
	...
	public Integer getEnterpriseYyzzzId() {
		return enterpriseYyzzzId;
	}

	public void setEnterpriseYyzzzId(Integer enterpriseYyzzzId) {
		this.enterpriseYyzzzId = enterpriseYyzzzId;
	}

	public String getEnterpriseYyzzzURL() {
		return enterpriseYyzzzURL;
	}

	public void setEnterpriseYyzzzURL(String enterpriseYyzzzURL) {
		this.enterpriseYyzzzURL = enterpriseYyzzzURL;
	}

	public String getEnterpriseYyzzzExtendName() {
		return enterpriseYyzzzExtendName;
	}

	public void setEnterpriseYyzzzExtendName(String enterpriseYyzzzExtendName) {
		this.enterpriseYyzzzExtendName = enterpriseYyzzzExtendName;
	}
	...
	public Integer getEnterprisetyjId() {
		return enterprisetyjId;
	}

	public void setEnterprisetyjId(Integer enterprisetyjId) {
		this.enterprisetyjId = enterprisetyjId;
	}

	public String getTongyishehuixinyongdaimaURL() {
		return tongyishehuixinyongdaimaURL;
	}

	public void setTongyishehuixinyongdaimaURL(String tongyishehuixinyongdaimaURL) {
		this.tongyishehuixinyongdaimaURL = tongyishehuixinyongdaimaURL;
	}

	public String getTongyishehuixinyongdaimaExtendName() {
		return tongyishehuixinyongdaimaExtendName;
	}

	public void setTongyishehuixinyongdaimaExtendName(
			String tongyishehuixinyongdaimaExtendName) {
		this.tongyishehuixinyongdaimaExtendName = tongyishehuixinyongdaimaExtendName;
	}
