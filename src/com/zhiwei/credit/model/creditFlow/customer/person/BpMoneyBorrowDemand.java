...
public class BpMoneyBorrowDemand extends com.zhiwei.core.model.BaseModel {
	...
	//睿本金融新加字段
    protected  String  termBorrowing;  // 贷款期限
    protected  Integer reimbursementMeans; // 还款方式
    protected  String  applyNum;//申请成数 
    protected  String  microMessage;//微信
    protected  String  incomeType;//收入认定方式
	...
	public String getTermBorrowing() {
		return termBorrowing;
	}

	public void setTermBorrowing(String termBorrowing) {
