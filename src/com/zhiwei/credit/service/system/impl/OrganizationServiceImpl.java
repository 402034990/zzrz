...
public class OrganizationServiceImpl extends BaseServiceImpl<Organization> implements OrganizationService{
	...
	@Override
	public List<Organization> getDepartmentList(PagingBean pb,String str) {
		String hql1=" from Organization as o where o.orgType=2";
     ...
     */
    public List<Organization> listAllBranch(HttpServletRequest httpServletRequest){
    	return this.dao.listAllBranch(httpServletRequest);
    }
    /**
