 ...
 * @author tianhuiguo 
 * */
public class DocumentTempletIntermediary extends BaseModel{
	...
	public DocumentTempletIntermediary() {
	}

	public DocumentTempletIntermediary(int id, String text, int parentid, int leaf,
