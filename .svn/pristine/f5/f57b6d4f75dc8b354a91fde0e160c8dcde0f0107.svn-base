 ...
 * @extends Ext.Panel
 */
bakBusinessManagement = Ext.extend(Ext.Panel, {
	projectStatus : 0,
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		bakBusinessManagement.superclass.constructor.call(this, {
			id : 'bakBusinessManagement' + this.projectStatus,
...
//						name :"orgUserId",
		...
		this.topbar = new Ext.Toolbar({
			items : [{
				...
				handler : function() {
					new businessStatusRegisterFrom().show();
					//打开业务定制页面
