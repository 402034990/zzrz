 ...
 * @createtime:
 */
TabSlFundIntentServiceMoney= Ext.extend(Ext.Panel, {
			// 构造函数
			...
			constructor : function(_cfg) {
				...
				// 调用父类构造
				TabSlFundIntentServiceMoney.superclass.constructor.call(this, {
							id : 'TabSlFundIntentServiceMoney'+this.businessType,
							title : '财务服务费台账',
