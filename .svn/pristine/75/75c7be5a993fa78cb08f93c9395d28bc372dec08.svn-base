 ...
 * @company 智维软件
 */ 
LoanSpreadcalculateFundIntent = Ext.extend(Ext.Window, {
			...
			if(typeof(_cfg.isHiddenbackBtn)!="undefined")
			{
				...
				LoanSpreadcalculateFundIntent.superclass.constructor.call(this, {
							id : 'calculateFundIntentWin1',
							border : false,
				            title: "贷款试算", 
				            autoScroll: true, 
				            maximizable :true,
			...
			initUIComponents : function() {
				var objectfinace=this.objectfinace;
				var projectInfoFinance= new LoanSpreadcalulateFinancePanel({
					...
					idDefinition:'calculate' ,
					 ...
					 isPreposePayConsultingCheck:this.isPreposePayConsultingCheck,
					 overdueRate:this.overdueRate,
					 overdueRateLoan:this.overdueRateLoan,
				...
				var gridPanel = new LoanSpreadcaluateIntentGrid({
				...
				fillDatacalulate(projectInfoFinance,'calculate',this.projectId,this.projectMoney,this.payaccrualType,this.accrualtype,this.isStartDatePay,this.isPreposePayAccrual,this.isInterestByOneTime,this.dateMode);
