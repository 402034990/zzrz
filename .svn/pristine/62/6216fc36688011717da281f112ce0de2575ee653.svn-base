var jStorePersonWin;
var selectCsCooperationEnterprise= function(funName,type) {
	var anchor = '96.5%';
	jStorePersonWin = new Ext.data.JsonStore({
        url : __ctxPath + "/creditFlow/customer/cooperation/listCsCooperationEnterprise.do?Q_isUsing_S_EQ=0&Q_type_S_EQ="+type,
