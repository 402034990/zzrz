...
/**
 * VProcreditDictionary entity. @author MyEclipse Persistence Tools
 */

public class VProcreditDictionary extends BaseVProcreditDictionaryExceptFinancing implements java.io.Serializable {
	...
	private String unchainremark;//解除备注
	...
	private String valuationMechanism;
	private Date valuationTime;
	private Long fundProjectId;//bpFundProject的主键Id
	
	private String oppositeType;//客户类型
	
	private Short projectStatus;//项目状态
	
	protected Short storehouseStatus;//出库、入库状态
	private String carNumber;   // 车辆编号
	private String imei;  //设备号
	private String manufacturerName;//品牌名
	private String carXi;//车系
	private String modelName;//车型
	private String zoneName;//城市
	@Expose
	private Integer isGPS;// 0 否 1是  安装GPS
	...
	public VProcreditDictionary() {
		super();
	}

	
	
	public VProcreditDictionary(String assuremodeidValue,
			...
			String enregisterDepartment,String businessType,String businessTypeValue,Integer fileCounts,Boolean isunchain,
			String mortgageStatus,String transactPerson,String unchainPerson,String transactRemarks,String unchainremark,
			Integer dywId,String mortgageRemarks,String companyName,Boolean isRecieve,Date recieveDate,String recieveRemarks,
			BigDecimal finalCertificationPrice,String valuationMechanism,Date valuationTime,String imei) {
		super();
	...
	public void setStorehouseStatus(Short storehouseStatus) {
