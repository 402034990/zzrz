...
public class SlFundDetailIntermediary extends com.zhiwei.core.model.BaseModel {

    protected Long fundDetailId;
//	protected Long fundIntentId;
//	protected Long fundQlideId;
    protected SlFundIntentIntermediary slFundIntent;
//    protected SlFundQlide slFundQlide;
	

	protected Long overdueNum;
	protected java.math.BigDecimal overdueAccrual; //逾期金额
	protected java.math.BigDecimal penaltyAccrual; //罚息金额
	 ...
	 */
	public SlFundDetailIntermediary () {
		super();
	}
	...
	public SlFundIntentIntermediary getSlFundIntent() {
		return slFundIntent;
	}

	public void setSlFundIntent(SlFundIntentIntermediary slFundIntent) {
...
//	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof SlFundDetailIntermediary)) {
			return false;
		}
		SlFundDetailIntermediary rhs = (SlFundDetailIntermediary) object;
	...
	public java.math.BigDecimal getPenaltyAccrual() {
		return penaltyAccrual;
	}

	public void setPenaltyAccrual(java.math.BigDecimal penaltyAccrual) {
