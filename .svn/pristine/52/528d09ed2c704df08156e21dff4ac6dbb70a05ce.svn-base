var personData;
var jStorePersonWin;
var selectPWName = function(funName,obj) {
	var anchor = '96.5%';
...
//			autoExpandColumn : 7,
			...
			listeners : {																																							
				'rowdblclick' : function(grid, index, e) {
					...
					callbackFun(selected,funName,obj);
					personWin.destroy();
				}
			}
		});
		...
		var callbackFun = function(selected,funName,obj){
		personJsonObj = {
					id : selected.get('id'),
					...
					personNumber : selected.get('personNumber')
				}
