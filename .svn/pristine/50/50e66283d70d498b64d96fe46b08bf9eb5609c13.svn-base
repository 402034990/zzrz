...
public class BpFundProjectAction extends BaseAction {
	...
	public String projectList(){
		...
		String isAll=(String) this.getRequest().getSession().getAttribute("isAll");
		...
		switch (projectStatus) {
			case 1:
				projectStatuses.append(Constants.PROJECT_STATUS_MIDDLE).append(",").append(Constants.PROJECT_POSTPONED_STATUS_ACT).append(",")
			...
			case 7:
				projectStatuses.append(Constants.PROJECT_STATUS_MIDDLE).append(",")
							   ...
							   .append(Constants.PROJECT_POSTPONED_STATUS_PASS).append(",")
							   .append(Constants.PROJECT_POSTPONED_STATUS_REFUSE).append(",")
							   .append(Constants.PROJECT_SUPERVISE_STATUS_MIDDLE).append(",")
							   .append(Constants.PROJECT_STATUS_BREAKACONTRACT).append(",")
							   .append(Constants.PROJECT_SUPERVISE_STATUS_COMPLETE).append(",")
							   .append(Constants.PROJECT_STATUS_SUSPENDED)
									   ;
				break;
			case 8:
