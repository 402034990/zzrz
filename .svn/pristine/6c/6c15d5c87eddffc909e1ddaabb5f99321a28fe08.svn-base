...
public class Person extends BaseModel  implements  java.io.Serializable {
	...
	private Double jobPay;//月负债
	private Double payScale;//负债比
    ...
    protected Integer businessLicense; //营业执照   0无 1有
    protected java.util.Date businessStateDate;  //  营业时间
    protected java.util.Date businessEndDate;  // 营业时间至
    protected String  networkUrl;//  网址
    protected  Integer  isSocialCare;  // 0  无  1 有
    protected  java.util.Date  livingDate;  // 起居时间
    private java.util.Date rentHouseStartDate;  // 租房起租时间
    private java.util.Date comeLocalDate;  // 来本地时间
    private  String  sharesPsrson;// 企业界面持股比例 单位％
    private  String  socialMoney;  // 社保缴存基数 
    private  String  publicMoney;  //公积金缴存基数
	//不与数据库映射
	...
	public String getSharesPsrson() {
		return sharesPsrson;
	}

	public void setSharesPsrson(String sharesPsrson) {
		this.sharesPsrson = sharesPsrson;
	}

	public java.util.Date getRentHouseStartDate() {
		return rentHouseStartDate;
	}

	public void setRentHouseStartDate(java.util.Date rentHouseStartDate) {
		this.rentHouseStartDate = rentHouseStartDate;
	}

	public java.util.Date getComeLocalDate() {
		return comeLocalDate;
	}

	public void setComeLocalDate(java.util.Date comeLocalDate) {
		this.comeLocalDate = comeLocalDate;
	}
	...
	public java.util.Date getLivingDate() {
		return livingDate;
	}

	public void setLivingDate(java.util.Date livingDate) {
	...
	public java.util.Date getBusinessStateDate() {
		return businessStateDate;
	}

	public void setBusinessStateDate(java.util.Date businessStateDate) {
		this.businessStateDate = businessStateDate;
	}
	...
	public Integer getIsSocialCare() {
		return isSocialCare;
	}

	public void setIsSocialCare(Integer isSocialCare) {
