function fillDataSupervise(mainObj,idDefinition,projectId,projectMoney,payaccrualType,accrualtype,isStartDatePay,isPreposePayAccrualsupervise,isInterestByOneTime,dateMode){
				...
				//未知控件
				var isPreposePayConsultingCheckObj = mainObj.getCmpByName('isPreposePayAccrualsupervise');
				var isPreposePayConsultingCheck = isPreposePayAccrualsupervise;
