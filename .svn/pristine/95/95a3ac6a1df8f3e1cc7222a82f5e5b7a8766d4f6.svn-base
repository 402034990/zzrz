...
//		}
     ...
     */
    public List<Organization> listAllBranch(HttpServletRequest request){
    	String agentName=request.getParameter("agentNames");
    	String branchNumber=request.getParameter("branchNumber");
    	StringBuffer sb = new StringBuffer();
    	StringBuffer hql = new StringBuffer("from Organization o where o.orgType=2 and (o.delFlag=1 or o.delFlag is null)");
    	if(agentName!=null&&!"".equals(agentName)){
    		hql.append(" and orgName like '%"+agentName+"%' ");
    	}
    	if(branchNumber!=null&&!"".equals(branchNumber)){
    		hql.append(" and branchNO like '%"+branchNumber+"%' ");
    	}
    	return findByHql(hql.toString());
    }
