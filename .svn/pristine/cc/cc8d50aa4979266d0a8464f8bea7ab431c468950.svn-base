 ...
 *
 * 款项计划信息表  SlFundIntenttermediary
 * 				 SlFundIntentIntermediary
 */
@SuppressWarnings("serial")
public class SlFundIntentIntermediary extends com.zhiwei.core.model.BaseModel {
	...
	protected java.math.BigDecimal overdureMoney;  //逾期金额
	protected String remark;
	protected Long lastslFundintentUrgeId;  //最后催收时间
	private Set<SlFundDetailIntermediary> slFundDetails = new HashSet<SlFundDetailIntermediary>(
			0);
...
//	protected com.zhiwei.credit.model.project.SlSmallloanProject slSmallloanProject;
	...
	protected java.math.BigDecimal overdueRate;//逾期利率
	protected java.math.BigDecimal penaltyRate;//罚息利率
	...
	protected BigDecimal overdueAfterMoney; //逾期已还金额
	...
	protected BigDecimal principalRepayment;//本金
	protected BigDecimal loanInterest;//利息
	protected BigDecimal consultationMoney;//管理咨询费
	protected BigDecimal serviceMoney;//财务服务费
	protected BigDecimal synthesizeMoney;//综合费用
	protected BigDecimal synthesizeAfterMoney;//已对账金额
	protected BigDecimal punishMoney;//总罚息
	protected BigDecimal notSynthesizeMoney;//未对账合计金额
	
	protected BigDecimal interestTax;//利息税
	protected BigDecimal penaltyTax;//罚息税
	protected BigDecimal overdureTax;//逾期利息税
	
	/**
	 * 是否为手动撤销处理  
	 * 1:是
	 */
	protected Short isManual;
	
	//不与数据库映射字段
	protected BigDecimal fxnotMoney;//罚息未对账金额
	protected BigDecimal overNotMoney;//逾期未对账金额
	protected Integer interestDays;//计息天数
	...
	public Set<SlFundDetailIntermediary> getSlFundDetails() {
		return slFundDetails;
	}

	public void setSlFundDetails(Set<SlFundDetailIntermediary> slFundDetails) {
	 ...
	 */
	public SlFundIntentIntermediary () {
		super();
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof SlFundIntentIntermediary)) {
			return false;
		}
		SlFundIntentIntermediary rhs = (SlFundIntentIntermediary) object;
	...
	public java.math.BigDecimal getOverdureMoney() {
		return overdureMoney;
	}

	public void setOverdureMoney(java.math.BigDecimal overdureMoney) {
		this.overdureMoney = overdureMoney;
	}
	...
	public BigDecimal getOverdueAfterMoney() {
		return overdueAfterMoney;
	}

	public void setOverdueAfterMoney(BigDecimal overdueAfterMoney) {
		this.overdueAfterMoney = overdueAfterMoney;
	}
	...
	public BigDecimal getOverNotMoney() {
		return overNotMoney;
	}

	public void setOverNotMoney(BigDecimal overNotMoney) {
		this.overNotMoney = overNotMoney;
	}
	...
	public BigDecimal getOverdureTax() {
		return overdureTax;
	}

	public void setOverdureTax(BigDecimal overdureTax) {
		this.overdureTax = overdureTax;
	}
