package com.credit.proj.mortgage.machineinfo.action;
...
public class MachineinfoAction extends CreditBaseAction {
	...
	private VProjMortMachineInfo vProjMortMachineInfo;
	...
	public void addMachineinfo() {
		try {
			...
			procreditMortgage.setMortgagenametypeid(pageconfig.MachineinfoID);
			...
			procreditMortgage.setMortgagepersontypeforvalue(pageconfig.MachineinfoValue);
	...
	public void seeMachineinfoForUpdate() throws Exception{
		...
		List list=machineinfoService.seeMachineinfo(rid);
		if(null!=list && list.size()!=0){
			vProjMortMachineInfo=(VProjMortMachineInfo)list.get(0);
			if("SmallLoan".equals(businessType) ||"BankCredit".equals(businessType)){
			...
			mapObject.put("vProjMortMachineInfo", vProjMortMachineInfo);
	...
	public void updateMachineinfo(){
		...
		try {
			machineinfoService.updateMachineinfo(mortgageid,procreditMortgageMachineinfo,procreditMortgage);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public MachineinfoService getMachineinfoService() {
		return machineinfoService;
	}

	public void setMachineinfoService(MachineinfoService machineinfoService) {
	...
	public VProjMortMachineInfo getvProjMortMachineInfo() {
		return vProjMortMachineInfo;
	}

	public void setvProjMortMachineInfo(VProjMortMachineInfo vProjMortMachineInfo) {
		this.vProjMortMachineInfo = vProjMortMachineInfo;
	}
