...
public class BpProductParameter extends com.zhiwei.core.model.BaseModel {
	 ...
	 * 手续费率(年)
	 */
	protected BigDecimal yearServiceChargeOfRate;
	/**
	 * 手续费率(月)
	 */
	 ...
	 * 手续费率(日)
	 */
	protected BigDecimal dayServiceChargeOfRate;
	/**
	 * 手续费率小计
	 */
	protected BigDecimal sumServiceChargeOfRate;
	/**
	 * 手续费固定金额
	 */
	protected BigDecimal fixedServiceChargeOfRate;
	/**
	 * 主体类别
	 */
	...
	protected BigDecimal overdueRateLoan;//逾期利率
	...
	public BigDecimal getSumServiceChargeOfRate() {
		return sumServiceChargeOfRate;
	}

	public void setSumServiceChargeOfRate(BigDecimal sumServiceChargeOfRate) {
		this.sumServiceChargeOfRate = sumServiceChargeOfRate;
	}

	public BigDecimal getFixedServiceChargeOfRate() {
		return fixedServiceChargeOfRate;
	}

	public void setFixedServiceChargeOfRate(BigDecimal fixedServiceChargeOfRate) {
		this.fixedServiceChargeOfRate = fixedServiceChargeOfRate;
	}

	public BigDecimal getYearServiceChargeOfRate() {
		return yearServiceChargeOfRate;
	}

	public void setYearServiceChargeOfRate(BigDecimal yearServiceChargeOfRate) {
		this.yearServiceChargeOfRate = yearServiceChargeOfRate;
	}
	...
	public BigDecimal getDayServiceChargeOfRate() {
		return dayServiceChargeOfRate;
	}

	public void setDayServiceChargeOfRate(BigDecimal dayServiceChargeOfRate) {
		this.dayServiceChargeOfRate = dayServiceChargeOfRate;
	}
