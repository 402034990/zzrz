 ...
 * @createtime:
 */
plateRechargeDeal = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				plateRechargeDeal.superclass.constructor.call(this, {
							id : 'plateRechargeDeal_'+this.isForBidType,
							title : '平台充值台账',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel=new HT.GridPanel({
					...
					//rowActions:true,
					id:'BpCustMemberGrid',
					url :__ctxPath + '/creditFlow/creditAssignment/bank/getPlateDealObAccountDealInfo.do?transferType=1',
					fields : [{
									name : 'id',
									type : 'int'
								}
