...
//	protected com.zhiwei.credit.model.project.SlSmallloanProject slSmallloanProject;
    ...
    protected String tinashu; // 逾期天数
    protected  BigDecimal yuqipayMoney; // 逾期利息
    protected  String  modelName;// 车型
    protected  java.util.Date startDate; // 贷款开始日期
    protected  String yewu;
    protected String teamManagerName;
	...
	public String getTinashu() {
		return tinashu;
	}
	public void setTinashu(String tinashu) {
		this.tinashu = tinashu;
	}
	public BigDecimal getYuqipayMoney() {
		return yuqipayMoney;
	}
	public void setYuqipayMoney(BigDecimal yuqipayMoney) {
		this.yuqipayMoney = yuqipayMoney;
	}
