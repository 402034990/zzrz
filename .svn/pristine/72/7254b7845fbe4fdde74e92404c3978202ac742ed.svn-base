...
public class BpPersonNetCheckInfo extends com.zhiwei.core.model.BaseModel {
	...
	protected Short isException; // 有无异常
	protected String remark;
	protected Integer checkUserId;
	// 睿本新加
	protected Long  nameNumeber;  // 过户次数
	protected Long  ViolationsNumber;//   违规次数
	...
	public Long getNameNumeber() {
		return nameNumeber;
	}

	public void setNameNumeber(Long nameNumeber) {
		this.nameNumeber = nameNumeber;
	}

	public Long getViolationsNumber() {
		return ViolationsNumber;
	}

	public void setViolationsNumber(Long violationsNumber) {
		ViolationsNumber = violationsNumber;
	}
