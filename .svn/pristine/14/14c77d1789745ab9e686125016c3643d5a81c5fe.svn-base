 ...
 * @createtime:
 */
SlFundIntentInterestIncomeShould = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentInterestIncomeShould.superclass.constructor.call(this, {
							id : 'SlFundIntentInterestIncomeShould'+this.businessType,
							title : '应收款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team2',
...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					rowActions : false,
					loadMask : true,
					id : 'SlFundIntentGrid2interestincome',
					isautoLoad:true,
					...
					fields : [{
							...
							'overdueRate', 'accrualMoney', 'status','remark','interestTax',
							'businessType','projectId','isInitialorId','orgName',
							'companyId','interestStarTime','interestEndTime','payintentPeriod','ids','bidPlanId'],
					columns : [{
								header : 'fundIntentId',
...
//			},
			...
			getfundType : function(){
				...
				if(this.businessType!=null){
					...
					switch (businessType) {
					  case "SmallLoan": sqlstr="&fundType=('loanInterest','interestPenalty')";
					    break;
				...
				var	record=s[0];
			     ...
			     if(record.data.payMoney !=0){   //payMoney
					...
					new SlFundIntentForm({
						...
						tabflag :"interestincome",companyId:record.data.companyId
					}).show();
