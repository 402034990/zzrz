...
public class OurArchivesMaterialsAction extends BaseAction{
	...
	public String getbyoperationTypeKey(){
		...
		if(null!=productId && !"".equals(productId)){
			...
			filter.addFilter("Q_productId_L_EQ",Long.valueOf(productId));
			filter.addFilter("Q_isPublic_SN_EQ",Short.valueOf("2"));
			List<OurArchivesMaterials> list= ourArchivesMaterialsService.getAll(filter);
