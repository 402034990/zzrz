	...
	this.SlProcreditMaterialsView = new SlEnterPriseProcreditMaterialsView(
		...
		this.outPanel = new Ext.Panel({
			...
			items : [{
				...
				title : '<a name="sl_bankcredtiTongyong_see'+ this.projectId
						+ '"><font color="red">02</font>授信信息</a>',
				items : [this.bankcredtiTongyong]
			},{
				title : '<a name="sl_bondPanel_see' + this.projectId
				...
				title : '<a name ="sl_contactPersonInfo_see'+ this.projectId
				...
				title : '<a name="sl_actualToChange_see' + this.projectId
