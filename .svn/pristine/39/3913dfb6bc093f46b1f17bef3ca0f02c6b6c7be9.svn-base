...
var enterpriseObj=Ext.extend(Ext.form.FormPanel, {
	enterpriseId:null,
	  ...
	  constructor : function(_cfg) {
			...
			if(_cfg.someReadOnly)
			{
			      this.someReadOnly=_cfg.someReadOnly;
			}
			var enterprise=this.enterprise;
			var person=this.person;
			var isReadOnly=this.isReadOnly;
			var someReadOnly=this.someReadOnly;
							...
							items : [{
								...
								items : [{
									...
									items : [{
											...
											xtype : "hidden",
											name:"enterpriseYyzzzId",
											value:enterprise==null?null:enterprise.enterpriseYyzzzId
									    },{
											xtype : "hidden",
											name:"enterprisetyjId",
											value:enterprise==null?null:enterprise.enterprisetyjId
									    },{
											xtype : "hidden",
									...
									columnWidth : 1,
									layout : 'form',
										hidden:enterprise==null?true:false,
									defaults : {
										anchor : anchor
									},
									items : [{
											...
											value:enterprise==null?null:enterprise.enterpriseNumber,
											listeners : {
												'afterrender':function(com){
													var person=enterprise;
													var personId=null;
													if(person==null){
														Ext.Ajax.request({
															url : __ctxPath
															+ '/creditFlow/customer/enterprise/createNumberEnterprise.do',
															method : 'POST',
															scope : this,
											...
											
									{
										...
										fieldLabel : '企业名称',
										allowBlank : false,
										readOnly:someReadOnly==true?true:isReadOnly,
										blankText : '企业名称不允许空',
										emptyText : '请输入企业名称',
...
//									 				a.dom.innerHTML ="<font color='red'>*</font>组织机构代码";
									...
									//	regex : /^[A-Za-z0-9]{8}-[A-Za-z0-9]{1}/ ,
										...
										listeners : {
											'blur' : function(f) {
												if(f.getValue() != ''){
													existenterNameAction(this,"validatorEnterOrganizecodeAjaxValidator","机构代码添加重复！");
												}
											},
											'afterrender':function(com){
											    com.clearInvalid();
...
//								}
							...
							items : [{
								...
								items : [{
										...
										scope:this,
										html : isReadOnly==false?'营业执照副本&nbsp;&nbsp;&nbsp;<a href="#"   onClick =uploadPhotoBtnEnterprise(\'营业执照副本\',\'cs_enterprise_yyzzfb\',\'yingyezhizhao\',\'enterpriseYyzzId\',\''+winId+'\')>上传</a>&nbsp;&nbsp;&nbsp;<a href="#" onClick =delePhotoFile_new(\'enterpriseYyzzId\',\'yingyezhizhao\',\''+winId+'\')>删除</a>':'营业执照副本'
									},{
										name:'yingyezhizhao',
										xtype :'label',
								...
								items : [{
										xtype :'label',
										style :'padding-left :10px',
										html : isReadOnly==false?'统一社会信用代码证&nbsp;&nbsp;&nbsp;<a href="#" onClick =uploadPhotoBtnEnterprise(\'统一社会信用代码证\',\'cs_enterprise_tyshxydm\',\'tongyishehuixinyongdaima\',\'enterprisetyjId\',\''+winId+'\')>上传</a>&nbsp;&nbsp;&nbsp;<a href="#" onClick =delePhotoFile_new(\'enterprisetyjId\',\'tongyishehuixinyongdaima\',\''+winId+'\')>删除</a>':'统一社会信用代码证'
									},{
										name:'tongyishehuixinyongdaima',
										xtype :'label',
										html : function(){	
											if(enterprise==null || enterprise.enterprisetyjId==0){
												return '<div style="width:144px; height:84px; margin:10px 0px 0px 10px; padding:1px 1px 1px 1px;"><img src="'
											+ getRootPath()
											+ '/images/nopic.jpg" width =140 height=80/></div>'
											}else if(null!=enterprise && enterprise.enterprisetyjId!=0 && (enterprise.tongyishehuixinyongdaimajExtendName==".jpg" || enterprise.tongyishehuixinyongdaimajExtendName==".jpeg")){
												return '<div style="width:144px; height:84px; margin:10px 0px 0px 10px; padding:1px 1px 1px 1px;border:1px solid #46A900;"><img src="' + getRootPath()
												+"/"+ enterprise.tongyishehuixinyongdaimaURL+'" ondblclick=showPic("'+enterprise.tongyishehuixinyongdaimaURL+'") width =140 height=80  /></div>'
											}else if(null!=enterprise && enterprise.enterprisetyjId!=0 && enterprise.tongyishehuixinyongdaimajExtendName==".pdf"){
												return '<div style="width:144px; height:84px; margin:10px 0px 0px 10px; padding:1px 1px 1px 1px;"><img src="'+getRootPath()+'//images//desktop//pdf_win.jpg" ondblclick=showPdf('+enterprise.enterprisetyjId+',"'+enterprise.tongyishehuixinyongdaimaURL+'") width =140 height=80  /></div>'
											}
										}()
									}]
							}]
								...
								items : [{
										xtype :'label',
										style :'padding-left :10px',
										html : isReadOnly==false?'营业执照正本&nbsp;&nbsp;&nbsp;<a href="#" onClick =uploadPhotoBtnEnterprise(\'营业执照正本\',\'cs_enterprise_yyzzzfb\',\'yingyezhizhaozheng\',\'enterpriseYyzzzId\',\''+winId+'\')>上传</a>&nbsp;&nbsp;&nbsp;<a href="#" onClick =delePhotoFile_new(\'enterpriseYyzzzId\',\'yingyezhizhaozheng\',\''+winId+'\')>删除</a>':'营业执照正本'
									},{
										name:'yingyezhizhaozheng',
										xtype :'label',
										style :'padding-left :20px',
										html :function(){debugger
											if(enterprise==null || enterprise.enterpriseYyzzzId==0){
												return '<div style="width:144px; height:84px; margin:10px 0px 0px 10px; padding:1px 1px 1px 1px;"><img src="'
											+ getRootPath()
											+ '/images/nopic.jpg" width =140 height=80/></div>'
											}else if(null!=enterprise && enterprise.enterpriseYyzzzId!=0 && (enterprise.enterpriseYyzzzExtendName==".jpg" || enterprise.enterpriseYyzzzExtendName==".jpeg")){
												return '<div style="width:144px; height:84px; margin:10px 0px 0px 10px; padding:1px 1px 1px 1px;border:1px solid #46A900;"><img src="' + getRootPath()
												+"/"+ enterprise.enterpriseYyzzzURL+'" ondblclick=showPic("'+enterprise.enterpriseYyzzzURL+'") width =140 height=80  /></div>'
											}else if(null!=enterprise && enterprise.enterpriseYyzzzId!=0 && enterprise.enterpriseYyzzzExtendName==".pdf"){
												return '<div style="width:144px; height:84px; margin:10px 0px 0px 10px; padding:1px 1px 1px 1px;"><img src="'+getRootPath()+'//images//desktop//pdf_win.jpg" ondblclick=showPdf('+enterprise.enterpriseYyzzzId+',"'+enterprise.enterpriseYyzzzURL+'") width =140 height=80  /></div>'
											}
										}()
									}]
							},{
										...
										xtype : 'hidden'
											...
											items : [{
												...
												listeners : {
													...
													columnWidth : 0.47, // 该列在整行中所占的百分比
													layout : "form", // 从上往下的布局
													items : [{
														xtype : "textfield",
														name : "person.sharesPsrson",
														value:person==null?null:person.sharesPsrson,
														readOnly:isReadOnly,
														fieldLabel : "持股比例",
														anchor : "100%"
														/*listeners : {
								...
								handler : function() {
									...
									if (null==enterpriseId || ""==enterpriseId) {
										...
										return;
									  	...
									  	new AccountIndexView({enterpriseId:enterpriseId,isReadOnly:isReadOnly,customerType:'company_customer',title:"财务汇总表"}).show()
								}
							},{
								xtype : 'button', // 员工结构2
								text : '员工结构',
