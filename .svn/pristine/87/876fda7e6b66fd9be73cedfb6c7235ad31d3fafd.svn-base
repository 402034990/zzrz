...
//			url : __ctxPath + '/project/saveSlSmallloanProject.do',
	...
	createContract:function(){
		var cpanel=this.grid_sharteequity;
		...
		var win=new Ext.Window({
			...
			items : [{
				...
				items : [{
					...
					items : [{
						...
						editable:false,//@HT_version3.0
						allowBlank:false,//@HT_version3.0
						valueField : 'itemId',
						triggerAction : 'all',
						store : new Ext.data.SimpleStore({
							autoLoad : true,
							url : __ctxPath
									+ '/contract/listByMarkDocumentTemplet.do?mark='+this.htType,
			...
			buttons : [{
				...
				handler :function(){
					...
					var documenttempletId=this.ownerCt.ownerCt.getCmpByName('documenttempletId').getValue()
					var args={
						projId :projectId ,
						bidPlanId:bidPlanId,
