 ...
 * @createtime:
 */
SlFundIntentprincipalIncomeActual = Ext.extend(Ext.Panel, {
		// 构造函数
		constructor : function(_cfg) {
			...
			// 调用父类构造
			SlFundIntentprincipalIncomeActual.superclass.constructor.call(this, {
				id : 'SlFundIntentprincipalIncomeActual'+this.businessType+this.type,
				title : '实收款项',
				region : 'center',
				layout : 'border',
				iconCls :'btn-team2',
		...
		initUIComponents : function() {
			...
			this.gridPanel = new HT.GridPanel({
				...
				rowActions : false,
				loadMask : true,
				id : 'SlFundIntentGrid4principalincome',
				isautoLoad:true,
