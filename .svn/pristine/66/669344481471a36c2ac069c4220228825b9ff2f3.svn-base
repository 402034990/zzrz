...
public class OurProcreditMaterialsEnterpriseIntermediary extends com.zhiwei.core.model.BaseModel {
	 ...
	 */
	public OurProcreditMaterialsEnterpriseIntermediary () {
		super();
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof OurProcreditMaterialsEnterpriseIntermediary)) {
			return false;
		}
		OurProcreditMaterialsEnterpriseIntermediary rhs = (OurProcreditMaterialsEnterpriseIntermediary) object;
