...
//	protected Long personId;
	...
	protected java.math.BigDecimal newCarValue;  // 裸车价
   ...
   // 睿本金融 添加
	protected  Integer iscourt;  // 法院是否执行
	protected  String  CreditStatus;  //信用情况
    protected   java.util.Date registrationDate; // 上牌时间
    protected  java.util.Date factoryDate;// 出厂日期
    protected  String  kmDriving; // 公里数
	/**
	...
	public String getKmDriving() {
		return kmDriving;
	}

	public void setKmDriving(String kmDriving) {
		this.kmDriving = kmDriving;
	}
	...
	public Integer getIscourt() {
		return iscourt;
	}

	public void setIscourt(Integer iscourt) {
