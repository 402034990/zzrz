		...
		document.writeln('<script type="text/javascript" src="'+__ctxPath+'/js/reportUtil.js"></script>');
   ...
   var storeTheme=getCookie('theme');
	  ...
	  JSLoader.loadJavaScript(__ctxPath+"/ext3/miframe.js");
        ...
        // JSLoader.loadJavaScript(__ctxPath+"/js/fckeditor/custom/plugins/flvPlayer/swfobject.js");
		 ...
		 JSLoader.loadJavaScript(__ctxPath+"/js/md5.js");
		 ...
		 JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/vehicle/cs_tn_seeVehicle.js" );
		  JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/vehicle/cs_tn_seeQualifiedVehicle.js" );
		   JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/vehicle/cs_tn_seeNoQualifiedVehicle.js" );
		 ...
		 JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/relieveMortgageWindow.js" );
		  JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/car/CarStorageWindow.js" );
		 ...
		 JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/UpdateBaozMortgageWin.js" );
		  JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/vehicle/VehicleQualifiedForm.js" );
		   JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/vehicle/VehicleNoQualifiedForm.js" );
	    ...
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/customer/enterprise/AccountIndexView.js");
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/customer/enterprise/AccountIndexForm.js");
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/customer/enterprise/AccountSumView.js");
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/customer/enterprise/AccountSumForm.js");
...
/*招标详情*/
		...
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/customer/cooperation/selectCsCooperationPerson.js");
		//授信专用
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/agent/BankCreditSelect.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/agent/CashDepositSelect.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/report/SlReportViewSeeWin.js");
		
		
		/** 贷款试算*/
		JSLoader.loadJavaScript(__ctxPath+"/js/loanTrial/LoanTrialForm.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/loanTrial/LoanTrialFormPanel.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/loanTrial/LoanTrialFormGrid.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/loanTrial/LoanTrialFormGridSum.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/loanTrial/LoanTrialLoadData.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/loanTrial/LoanTrialFormPanelPrincipal.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/loanTrial/LoanTrialProductFormPanel.js");
		/** 睿本结清流程手动对账*/
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/finance/SlFundIntentForm.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/finance/SlActualToChargeForm.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/finance/chargeeditQlideCheck.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/finance/editQlideCheck.js");
		/**客户查询算*/
		JSLoader.loadJavaScript(__ctxPath+"/js/customerTool/CustomerToolForm.js");
		JSLoader.loadJavaScript(__ctxPath+"/js/customerTool/CustomerToolFormPanel.js");
		
		/**社保和公积金*/
		JSLoader.loadJavaScript(__ctxPath+"/js/bankIntermediary/customerFileManagement/customerManagement/SocialSecurityFund.js");
		/**查看借款意向*/
		JSLoader.loadJavaScript(__ctxPath+"/js/bankIntermediary/customerFileManagement/customerManagement/SeeBorrowingIntention.js");
		/**借款意向详情*/
		JSLoader.loadJavaScript(__ctxPath+"/js/bankIntermediary/customerManagement/BorrowingIntention.js");
		/**借款意向详细信息*/
		JSLoader.loadJavaScript(__ctxPath+"/js/bankIntermediary/customerFileManagement/customerManagement/SeeBorrowingIntentionDetail.js");
		/**目前业务*/
		JSLoader.loadJavaScript(__ctxPath+"/js/bankIntermediary/customerFileManagement/customerManagement/CurrentBusiness.js");
		/**合同管理*/
		JSLoader.loadJavaScript(__ctxPath+"/js/bankIntermediary/customerFileManagement/customerManagement/ContractManagement.js");
		/**车辆js*/  
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/ProcreditMortgageCarGpsForm.js");
	     JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/gpsInstallRegister.js");
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/CarGpsView.js");
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/CarGpsForm.js");
	    JSLoader.loadJavaScript(__ctxPath+"/js/creditFlow/mortgage/SlMortgageCarGpsMaterialsView.js");
		}
