function fillData(mainObj, alarm_fields, idDefinition) {
	...
	var isStartDatePay = alarm_fields.data.slSmallloanProject.overdueReceiveWay;
	if (isStartDatePay == "1") {
		if(Ext.getCmp("yqsqfs2"+idDefinition)){
			Ext.getCmp("yqsqfs2"+idDefinition).setValue(true);
		}
		if(Ext.getCmp("yqsqfs1"+idDefinition)){
			Ext.getCmp("yqsqfs1"+idDefinition).setValue(false);
		}
	} else {
		if(Ext.getCmp("yqsqfs2"+idDefinition)){
			Ext.getCmp("yqsqfs2"+idDefinition).setValue(false);
		}
		if(Ext.getCmp("yqsqfs1"+idDefinition)){
			Ext.getCmp("yqsqfs1"+idDefinition).setValue(true);
		}
	}
	
	//罚息收取方式 
	var isStartDatePay = alarm_fields.data.slSmallloanProject.penaltyReceiveWay;
	if (isStartDatePay == "1") {
		if(Ext.getCmp("fxsqfs2"+idDefinition)){
			Ext.getCmp("fxsqfs2"+idDefinition).setValue(true);
		}
		if(Ext.getCmp("fxsqfs1"+idDefinition)){
			Ext.getCmp("fxsqfs1"+idDefinition).setValue(false);
		}
	} else {
		if(Ext.getCmp("fxsqfs2"+idDefinition)){
			Ext.getCmp("fxsqfs2"+idDefinition).setValue(false);
		}
		if(Ext.getCmp("fxsqfs1"+idDefinition)){
			Ext.getCmp("fxsqfs1"+idDefinition).setValue(true);
		}
	}
	//保证金释放方式
	var isStartDatePay = alarm_fields.data.slSmallloanProject.depositsReleaseWay;
	if (isStartDatePay == "1") {
		if(Ext.getCmp("release2"+idDefinition)){
			Ext.getCmp("release2"+idDefinition).setValue(true);
		}
		if(Ext.getCmp("release1"+idDefinition)){
			Ext.getCmp("release1"+idDefinition).setValue(false);
		}
	} else {
		if(Ext.getCmp("release2"+idDefinition)){
			Ext.getCmp("release2"+idDefinition).setValue(false);
		}
		if(Ext.getCmp("release1"+idDefinition)){
			Ext.getCmp("release1"+idDefinition).setValue(true);
		}
	}
	//提前还款违约金收取方式
	var prepayMoney = alarm_fields.data.slSmallloanProject.prepayMoney;
	if (prepayMoney == "1") {
		if(Ext.getCmp("tqhkje2"+idDefinition))
			Ext.getCmp("tqhkje2"+idDefinition).setValue(true);
		if(Ext.getCmp("tqhkje1"+idDefinition))
		Ext.getCmp("tqhkje1"+idDefinition).setValue(false);
	} else {
		if(Ext.getCmp("tqhkje1"+idDefinition))
		Ext.getCmp("tqhkje1"+idDefinition).setValue(true);
		if(Ext.getCmp("tqhkje2"+idDefinition))
		Ext.getCmp("tqhkje2"+idDefinition).setValue(false);
	}
	//保证金释放方式
	var depositsReleaseWay = alarm_fields.data.slSmallloanProject.depositsReleaseWay;
	...
	//授信释放方式
	var creditfreedType = alarm_fields.data.slSmallloanProject.creditfreedType;
	if (creditfreedType == "1") {
		if(Ext.getCmp("credit2"+idDefinition))
		Ext.getCmp("credit2"+idDefinition).setValue(true);
		if(Ext.getCmp("credit1"+idDefinition))
		Ext.getCmp("credit1"+idDefinition).setValue(false);
	} else {
		if(Ext.getCmp("credit1"+idDefinition))
		Ext.getCmp("credit1"+idDefinition).setValue(true);
		if(Ext.getCmp("credit2"+idDefinition))
		Ext.getCmp("credit2"+idDefinition).setValue(false);
	}
...
//			var combo2 = Ext.getCmp("slsmallmineid");
	if (null != managementConsultingMineTypeVal
			&& "" != managementConsultingMineTypeVal && null!=combo) {
	...
	if (null != financeServiceMineTypeVal && "" != financeServiceMineTypeVal && null!=combo1) {
		...
		if (null != mineTypeVal && "" != mineTypeVal && typeof(combo2)!='undefined' && null!=combo2) {
