 ...
 */
ReportMenuCommon = Ext.extend(Ext.Panel, {
	panel:null,
	url:'',
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		ReportMenuCommon.superclass.constructor.call(this, {
			id : 'ReportMenuCommon'+this.reportKey,
			title : this.title,
			layout : 'border',
	...
	initUIComponents : function() {
		...
		this.url=__ctxPath + '/system/submitCommonReportTemplate.do';
