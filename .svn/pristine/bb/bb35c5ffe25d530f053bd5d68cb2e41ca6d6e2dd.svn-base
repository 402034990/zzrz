...
SlFundintentUrgTab= Ext.extend(Ext.Panel, {
			...
			constructor : function(_cfg) {
				...
				SlFundintentUrgTab.superclass.constructor.call(this, {
							id : 'SlFundintentUrgTab'+this.businessType,
							title : (this.businessType=='SmallLoan' || this.businessType=='Pawn'||this.businessType=="LeaseFinance")?'还款催收':'还款提醒',
			...
			initUIComponents : function() {
				var itemschange=[new SlFundintentUrgeView({fundIntentId:this.fundIntentId,tabflag:"all",tabflagtitle:"全部款项",onclickflag:this.onclickflag,onclickisInterent:this.onclickisInterent,businessType : this.businessType}),
						         new SlFundintentUrgeView({fundIntentId:this.fundIntentId,tabflag:"coming",tabflagtitle:"即将到期",onclickflag:this.onclickflag,onclickisInterent:this.onclickisInterent,businessType : this.businessType}),
						         new SlFundintentUrgeView({fundIntentId:this.fundIntentId,tabflag:"overdue",tabflagtitle:"已逾期",onclickflag:this.onclickflag,onclickisInterent:this.onclickisInterent,businessType : this.businessType})
								];
