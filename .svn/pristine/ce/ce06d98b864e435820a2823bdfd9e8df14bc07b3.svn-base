 ...
 * @createtime:
 */
SlFundIntentPrincipalPayOwe = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentPrincipalPayOwe.superclass.constructor.call(this, {
							id : 'SlFundIntentPrincipalPayOwe'+this.businessType,
							title : this.businessType=='SmallLoan'?'欠放款项':'欠付款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team2',
