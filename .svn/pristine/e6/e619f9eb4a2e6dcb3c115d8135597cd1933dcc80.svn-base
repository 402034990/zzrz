...
public class CreditRating extends BaseModel {
	...
	private String carAssessmentValue;
	...
	public String getCarAssessmentValue() {
		return carAssessmentValue;
	}

	public void setCarAssessmentValue(String carAssessmentValue) {
		this.carAssessmentValue = carAssessmentValue;
	}
