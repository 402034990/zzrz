 ...
 * 个人客户-教育情况
 */
public class BpCustPersonEducationIntermediary extends com.zhiwei.core.model.BaseModel {
...
//	protected Integer personId;
	 ...
	 */
	public BpCustPersonEducationIntermediary () {
		super();
	}
...
//	PersonIntermediary
	public Integer getPersonId(){
		return this.getPersonIntermediary()==null?null:this.getPersonIntermediary().getId();
	}
	...
	public PersonIntermediary getPersonIntermediary() {
		return person;
	}

	public void setPersonIntermediary(PersonIntermediary person) {
		this.person = person;
	}
	...
	public boolean equals(Object object) {
		if (!(object instanceof BpCustPersonEducationIntermediary)) {
			return false;
		}
		BpCustPersonEducationIntermediary rhs = (BpCustPersonEducationIntermediary) object;
