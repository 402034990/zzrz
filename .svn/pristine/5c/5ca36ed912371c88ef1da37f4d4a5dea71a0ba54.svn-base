 ...
 * @createtime:
 */
OurSmallloanMaterialsView = Ext.extend(Ext.Panel, {
	dic_GPanel : null,
	tree_GPanel : null,
	constructor : function(_cfg) {
		...
		OurSmallloanMaterialsView.superclass.constructor.call(this, {
					id : 'OurSmallloanMaterialsView',
					layout : 'border',
					iconCls :'btn-team2',
					title : '贷款材料管理',
					/*
	...
	initUIComponents : function() {
			...
			handler : function() {
				var formPanel = new Ext.FormPanel({
					...
					items : [{
								...
								value : 'SmallLoan_SmallLoanBusiness'
							}, {
								xtype : 'hidden',
								name : 'ourProcreditMaterialsEnterprise.parentId',
								value : '0'
		...
		this.update_button_r = new Ext.Button({
			...
			handler : function() {
				...
				if (gselectid == '0') {
					Ext.ux.Toast.msg('操作提示', '请选择您要修改的贷款材料项！');
					return;
				}
				Ext.Ajax.request({
					url : __ctxPath
		...
		this.dic_GPanel = new HT.EditorGridPanel({
			...
			autoScroll : true,
			url : __ctxPath
					+ '/materials/listByOperationTypeKeyOurProcreditMaterialsEnterprise.do?operationTypeKey=SmallLoan_SmallLoanBusiness',// 融资租赁项目，默认以Guarantee_CompanyBusiness
