 ...
 * @createtime:
 */
SlFundIntentOtherPayAlready = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentOtherPayAlready.superclass.constructor.call(this, {
							id : 'SlFundIntentOtherPayAlready',
							title : '已付款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team2',
