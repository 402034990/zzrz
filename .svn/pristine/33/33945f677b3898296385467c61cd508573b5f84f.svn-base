 ...
 * @extends Ext.Panel
 */
PostponedProjectInfoNavigation = Ext.extend(Ext.Panel, {
	constructor : function(_cfg) {
		...
		PostponedProjectInfoNavigation.superclass.constructor.call(this, {
			region : 'center',
			layout : 'anchor',
			items : []
		});
					...
					items : [{
						...
						items : [{
							...
							items : [{
								...
								text : '01展期审批书',
								scope : this,
								disabled : !(isGranted('_applyForPostponed_'+ this.projectStatus)||isGranted('_seeapplyForPostponed_'+ this.projectStatus)),
								handler : function() {
							...
							items : [{
								...
								disabled : !(isGranted('_postponedContract_'+ this.projectStatus)||isGranted('_seepostponedContract_'+ this.projectStatus)),
								handler : function() {
						...
						items : [{
							...
							items : [{
								...
								text : '展期审贷会集体决议',
								scope : this,
								disabled : !(isGranted('_zqsdhjtjy_'+ this.projectStatus)||isGranted('_seezqsdhjtjy_'+ this.projectStatus)),
								handler : function() {
						...
						items : [{
							...
							items : [{
								...
								text : '展期流程示意图',
								scope : this,
								disabled : !(isGranted('_showZQFlowImg_'+ this.projectStatus)||isGranted('_seeshowZQFlowImg_'+ this.projectStatus)),
								handler : function() {
									var slSuperviseRecordId = this.slSuperviseRecordId;
									Ext.Ajax.request({
										url : __ctxPath + '/flow/getByBusinessTypeProcessNameTableIdProcessRun.do',
							...
							items : [{
								...
								text : '展期意见与说明记录',
								scope : this,
								disabled : !(isGranted('_zqRecords_'+ this.projectStatus)||isGranted('_seezqRecords_'+ this.projectStatus)),
								handler : function() {
									var slSuperviseRecordId = this.slSuperviseRecordId;
									Ext.Ajax.request({
										url : __ctxPath + '/flow/getByBusinessTypeProcessNameTableIdProcessRun.do',
							...
							items : [{
								...
								disabled : !(isGranted('_zqTaskChange_'+ this.projectStatus)||isGranted('_seezqTaskChange_'+ this.projectStatus)),
								handler : function() {
									var slSuperviseRecordId = this.slSuperviseRecordId;
									Ext.Ajax.request({
										url : __ctxPath + '/flow/getByBusinessTypeProcessNameTableIdProcessRun.do',
							...
							items : [{
								...
								text : '展期流程跳转',
								hidden : this.flag=='see'?true:false,
								disabled : !(isGranted('_zqTaskJump_'+ this.projectStatus)||isGranted('_seezqTaskJump_'+ this.projectStatus)),
								scope : this,
								handler : function() {
									var slSuperviseRecordId = this.slSuperviseRecordId;
									Ext.Ajax.request({
							...
							items : [{
								...
								text : '展期项目终止',
								hidden : this.flag=='see'?true:false,
								disabled : !(isGranted('_zqTaskStop_'+ this.projectStatus)||isGranted('_seezqTaskStop_'+ this.projectStatus)),
								scope : this,
								handler : function() {
									var slSuperviseRecordId = this.slSuperviseRecordId;
									Ext.Ajax.request({
