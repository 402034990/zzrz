 ...
 * @createtime:
 */
SlFundIntentPrincipalPayShould = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentPrincipalPayShould.superclass.constructor.call(this, {
							id : 'SlFundIntentPrincipalPayShould'+this.businessType+this.type,
							title : this.businessType=='SmallLoan'?'应放款项':'应付款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team2',
...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					rowActions : false,
					loadMask : true,
					id : 'SlFundIntentGrid2principalpay',
					isautoLoad:true,
					url : __ctxPath + "/creditFlow/finance/listbyLedgerSlFundIntent.do?businessType="+this.businessType+this.getfundType()+"&typetab=should",
					fields : [{
								name : 'fundIntentId',
								type : 'int'
