...
//						else if(showOrHide==1000){
//							return '<img title="点击下载附件" src="'+basepath()+'images/download-start.png" onclick="downLoadContractFilesNode13('+r.get('id')+')"/>';
//						}else{
//							return '';
//						}
//						return '<img title="点击下载附件" src="'+basepath()+'images/download-start.png" onclick="downloadContract(\''+entrustAgainstGuaranteeVal+'\',\''+piKey+'\',\''+(conObj2 == '' ? 0 : conObj2.id)+'\',\''+ENTRUST_REVERSE_GUARANTEE+'\')" />';
				};
				var funDoContract = function(val,m,r){
						if(showOrHide==15){
//							if(r.get('contractId')==''||r.get('contractId')==null){
