 ...
 *            是否可管理
 */
var ProDefinitionViewForCustomer = function(isManager) {
	this.isManager = isManager;
};

ProDefinitionViewForCustomer.prototype.setTypeId = function(typeId) {
	this.typeId = typeId;
	ProDefinitionView.typeId = typeId;
};

ProDefinitionViewForCustomer.prototype.getView = function() {
 ...
 * 建立视图
 */
ProDefinitionViewForCustomer.prototype.setup = function() {
						...
						if (deployId != null) {
							...
							if (isManager) {
								if (isGranted('_FlowSetting')) {
									str += '&nbsp;<button title="流程设置" class="btn-process" onclick="ProDefinitionViewForCustomer.setting('
											+ ''
											+ defId
											+ ',\''
											+ name
 ...
 * 初始化数据
 */
ProDefinitionViewForCustomer.prototype.store = function() {
	var _params = null;
	if(this.isManager){
		_params = {
 ...
 * 建立操作的Toolbar
 */
/*ProDefinitionViewForCustomer.prototype.topbar = function() {
 ...
 * 删除单个记录
 */
/*ProDefinitionViewForCustomer.remove = function(id) {
	var grid = Ext.getCmp("ProDefinitionGrid");
 ...
 * 清空
 */
ProDefinitionViewForCustomer.prototype.clean = function(){
 ...
 * 搜索
 */
ProDefinitionViewForCustomer.prototype.search = function(){
 ...
 * 
 */
/*ProDefinitionViewForCustomer.edit = function(id) {
 ...
 *            deployId
 */
/*ProDefinitionViewForCustomer.view = function(defId, name) {
 ...
 *            id
 */
ProDefinitionViewForCustomer.setting = function(defId, name) {

	var contentPanel = App.getContentPanel();
	var settingView = contentPanel.getItem('ProDefinitionSettingForCustomer' + defId);
	if (!settingView) {
		settingView = new ProDefinitionSettingForCustomer({defId:defId,name:name});
 ...
 *            name
 */
/*ProDefinitionViewForCustomer.newFlow = function(defId, name) {
	var contentPanel = App.getContentPanel();
 ...
 * Pro设置流程权限
 */
/* ProDefinitionViewForCustomer.rights = function(defId){
  ...
  * @param {} defId 流程主键id
  */
/* ProDefinitionViewForCustomer.reDesign = function(defId){
  ...
  * 
  */
 /*ProDefinitionViewForCustomer.edit = function(defId) {
