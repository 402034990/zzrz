...
PlThirdInterfaceLogView = Ext.extend(Ext.Panel, {
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					url : __ctxPath
							+ "/thirdInterface/listPlThirdInterfaceLog.do",
					fields : [{
								name : 'id',
								type : 'int'
							}, 'typeName', 'typeId', 'code', 'codeMsg',
							'bigMsg', 'createTime', 'interfaceName',
							'memberId', 'memberType','remark1','remark2','remark3'],
					columns : [{
								header : 'id',
								dataIndex : 'id',
								hidden : true
			...
			removeRs : function(id) {
				$postDel({
							url : __ctxPath
									+ '/thirdInterface/multiDelPlThirdInterfaceLog.do',
							ids : id,
							grid : this.gridPanel
						});
			},
