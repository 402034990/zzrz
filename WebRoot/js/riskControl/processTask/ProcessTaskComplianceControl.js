...
ProcessTaskComplianceControl = Ext.extend(Ext.Panel, {
	constructor : function(conf) {
		Ext.applyIf(this, conf);
		this.initUIComponents();
		ProcessTaskComplianceControl.superclass.constructor.call(this, {
					id:'ProcessTaskComplianceControl',
					title : '流程任务合规性监控',
	...
	initUIComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
					...
					url : __ctxPath + '/flow/getAllCompleteProcessTask.do',
					root : 'result',
	...
	toExcel:function(){
		...
		window.open(__ctxPath + '/flow/completeExportExcelTask.do?taskName='+taskName+"&userId="+userId+"&projectName="+projectName+"&taskstatus="+taskstatus+"&startDate="+startDate+"&endDate="+endDate+"&finishStartDate="+finishStartDate+"&finishEndDate="+finishEndDate,'_blank');
