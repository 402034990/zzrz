 ...
 * @createtime:
 */
BpPerApplyUserRejected = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpPerApplyUserRejected.superclass.constructor.call(this, {
							id : 'BpPerApplyUserRejected',
							title : '已拒绝',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/listBpFinanceApply.do?ck=0&state=2",
					fields : [{
								name : 'loanId',
								type : 'int'
							}, 'productId', 'linkPersion', 'phone',
							'loanMoney', 'isOnline', 'loanTimeLen', 'area',
							'remark', 'createTime', 'state','productName','businessName','remark'],
					columns : [{
								header : 'loanId',
								dataIndex : 'loanId',
								hidden : true
