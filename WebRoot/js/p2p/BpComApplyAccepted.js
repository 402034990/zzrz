 ...
 * @createtime:
 */
BpComApplyAccepted = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpComApplyAccepted.superclass.constructor.call(this, {
							id : 'BpComApplyAccepted',
							title : '已受理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/listBpFinanceApply.do?ck=1&state=1",
					fields : [{
								name : 'loanId',
								type : 'int'
