 ...
 * @createtime:
 */
BpComApplyNotAccepted = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				BpComApplyNotAccepted.superclass.constructor.call(this, {
							id : 'BpComApplyNotAccepted',
							title : '未受理',
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
				...
				this.gridPanel = new HT.GridPanel({
					...
					url : __ctxPath + "/p2p/listBpFinanceApply.do?ck=1&state="+this.type,
					fields : [{
								name : 'loanId',
								type : 'int'
