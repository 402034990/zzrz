			...
			initUIComponents : function() {
				...
				this.topbar = new Ext.Toolbar({
					items : [{
						...
						text : '授权产品',
						xtype : 'button',
						hidden : isGranted('_bpProductParameter_empower')?false:true,
						scope : this,
						handler : this.empowerSelRs
					}]
				});
				...
				this.gridPanel = new HT.GridPanel({
					...
					fields : [{
								name : 'id',
								type : 'int'
							 }, 'productName', 'createTime', 'rolerName','payintentPeriod','productStatus','borrowerType','accrualtype','payaccrualType','isPreposePayAccrual','isInterestByOneTime', 'isStartDatePay',
							   'payintentPerioDate','yearAccrualRate','accrual','dayAccrualRate','sumAccrualRate','productDescribe','mineType','mineId','operationType','businessType','productNumber'],
					columns : [{
							header : 'id',
							dataIndex : 'id',
							hidden : true
