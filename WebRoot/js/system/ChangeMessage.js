 ...
 * @company 智维软件
 */
ChangeMessage = Ext.extend(Ext.Window, {
	// 构造函数
	constructor : function(_cfg) {
		Ext.applyIf(this, _cfg);
		// 必须先初始化组件
		this.initUIComponents();
		ChangeMessage.superclass.constructor.call(this, {
					id : 'ChangeMessage',
					layout : 'fit',
	...
	initUIComponents : function() {
		this.formPanel = new Ext.FormPanel({
			layout : 'form',
			url : __ctxPath + '/system/updateBaseInfoSystemProperties.do',
		...
		if (formPanel.getForm().isValid()) {
			formPanel.getForm().submit({
				...
				success : function(form ,action) {  
					...
					if (res.e) {
						var gridPanel = Ext.getCmp('MessageAccountView');
