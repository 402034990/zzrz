...
my_image_window = Ext.extend(Ext.Window,{
		...
		my_image_window.superclass.constructor.call(this,{
			...
			items : [{
				...
				html : '<div id="mapPic" style="margin:auto; padding:0px auto;">'
						...
						+'<div style="position: absolute; bottom: 32px;width: 100px;left: 50%;margin-left: -56px; width: 100px;left: 50%; z-index: 1003;">' +
								'<img id="leftRotatePre" style="opacity:30;margin-left: 23px;margin-bottom: -8px;" onmouseover="show_img1(true)" onmouseout="show_img1(false)" src="publicmodel/uploads/css/imagesn/left_Rotation.png" />' +
								'</div>'
						
						+'<div style="position: absolute; bottom: 26px;width: 100px;left: 50%;margin-left: -24px; width: 100px;left: 50%; z-index: 1003;">' +
								'<img style="margin-left: 23px;margin-bottom: -8px;" src="publicmodel/uploads/css/imagesn/parting_Line.png" />' +
								'</div>'
								
						+'<div style="position: absolute; bottom: 26px;width: 100px;left: 50%;margin-left: -24px; width: 100px;left: 50%; z-index: 1003;">' +
								'<img id="rightRotatePre" style="opacity:30;margin-left: 41px;margin-bottom: -2px;" onmouseover="show_img2(true)" onmouseout="show_img2(false)" src="publicmodel/uploads/css/imagesn/right_Rotation.png" />' +
								'</div>'
								
						+'<img style="z-index:1001;position: absolute;bottom: 17px;width: 100px;left: 50%;margin-left: -50px;" src="publicmodel/uploads/css/imagesn/background.png" />'
	...
	pageInit : function() {
		...
		if (image != null) {
			...
			var current = 0;
			Ext.get('leftRotatePre').on({
				'click':function(){
					debugger
					current = (current-90)%360;
                	Ext.get('view-image').dom.style.transform = 'rotate('+current+'deg)';
				}
			});
			
			Ext.get('rightRotatePre').on({
				'click':function(){
					debugger
					current = (current+90)%360;
                	Ext.get('view-image').dom.style.transform = 'rotate('+current+'deg)';
...
function show_img1(choice){
    document.getElementById('leftRotatePre').style.width = !choice ? 15 : 17;
    document.getElementById('leftRotatePre').style.height = !choice ? 17 : 19;
}
function show_img2(choice){
    //document.getElementById('rightRotatePre').style.opacity = !choice ? 30 : 100;
    document.getElementById('rightRotatePre').style.width = !choice ? 15 : 17;
    document.getElementById('rightRotatePre').style.height = !choice ? 17 : 19;
}
