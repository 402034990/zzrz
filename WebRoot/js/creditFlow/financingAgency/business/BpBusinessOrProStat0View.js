BpBusinessOrProStat0View = Ext.extend(Ext.Panel, {
	/*
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		BpBusinessOrProStat0View.superclass.constructor.call(this, {
					id : 'BpBusinessOrProStat0View_' + this.managerType,
	...
	// 初始化搜索条件Panel
		...
		this.gridPanel = new HT.GridPanel({
			...
			url : __ctxPath
					+ "/creditFlow/financingAgency/business/listBpBusinessOrPro.do?Q_orginalType_SN_EQ="+this.orginalType+"&Q_keepStat_N_EQ="+this.State,
			fields : [{
						name : 'borProId',
						type : 'int'
