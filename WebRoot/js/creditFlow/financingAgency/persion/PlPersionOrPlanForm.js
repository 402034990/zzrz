									...
									items : [{
										...
										listeners : {
											...
											check : function(obj, checked) {
												Ext.getCmp("paymentPeriodComboBox").readOnly = true;
												Ext.getCmp("paymentPeriodComboBox").setValue(null);
											}
										},
										disabled : this.isReadOnly
									}]
...
//    	if(payWay==4)
//   Ext.getCmp('paymentWay1').boxLabel="按日付息到期还本";
//    	if(payWay==5)
//   Ext.getCmp('paymentWay1').boxLabel="期末一次性支付本息";
   	 if(payWay==1)
   Ext.getCmp('paymentWay1').boxLabel="等额本息";
    	if(payWay==2)
   Ext.getCmp('paymentWay1').boxLabel="等额本金";
    	if(payWay==3)
   Ext.getCmp('paymentWay1').boxLabel="等本等息 ";
    	if(payWay==4)
   Ext.getCmp('paymentWay1').boxLabel="按期收息,到期还本";
    	 
   },
   fillPayWay1:function(payWay){
      
   if(payWay=='dayPay')
   Ext.getCmp('payAcctualType1').boxLabel="日";
    	if(payWay=='monthPay')
   Ext.getCmp('payAcctualType1').boxLabel="月";
    	if(payWay=='seasonPay')
   Ext.getCmp('payAcctualType1').boxLabel="季 ";
    	if(payWay=='yearPay')
   Ext.getCmp('payAcctualType1').boxLabel="年";
