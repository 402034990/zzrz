...
FinanceMortgageView = Ext.extend(Ext.Panel, {
			// 构造函数
			gridPanel:null,
			isHidden:false,
			...
			constructor : function(_cfg) {
				...
				// 调用父类构造
				FinanceMortgageView.superclass.constructor.call(this, {
							layout:'anchor',
		  					anchor : '100%',
							//title : '抵质押物管理',
							//region : 'center',
		...
		//			)  
				...
				this.gridPanel = new HT.EditorGridPanel({
					...
					url : __ctxPath +'/credit/mortgage/getMortgageOfDY.do?projectId='+this.projectId+'&businessType='+this.businessType+'&isReadOnly=false',
					fields : [{
								name : 'id',
								type : 'int'
