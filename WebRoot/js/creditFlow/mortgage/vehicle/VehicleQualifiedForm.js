 ...
 * @createtime:
 */
VehicleQualifiedForm = Ext.extend(Ext.Panel, {
	// 构造函数
	constructor : function(_cfg) {
		...
		// 调用父类构造
		VehicleQualifiedForm.superclass.constructor.call(this, {
			anchor : '95%',
			items : [{
				layout : 'column',
				xtype : 'fieldset',
				title : '填写<车辆车易贷(有合格证)>详细信息',
				collapsible : true,
				autoHeight : true,				
				items : [{
					columnWidth : 1,
					...
					items : [{
						      ...
						      fieldLabel : '是否进口车'
								...
								fieldLabel : '钥匙数',
								allowBlank : false,
								name : 'procreditMortgageCar.keyCount'
							}]
				}, {
					columnWidth : .5,
					layout : 'form',
					...
					items : [{
						      ...
						      triggerAction : "all",
						      hiddenName : 'procreditMortgageCar.isNowCar',
						      anchor : "100%",
						      fieldLabel : '是否现车'
					},{
								xtype : "dickeycombo",
