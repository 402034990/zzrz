...
SlActualToCharge = Ext.extend(Ext.Panel, {
	...
	constructor : function(_cfg) {
		...
		if (_cfg.reconciliation) {
			this.reconciliation = _cfg.reconciliation;
		}
		if (_cfg.openliushuiwin) {
			this.openliushuiwin = _cfg.openliushuiwin;
		}
	...
	initUIComponents : function() {
		...
		this.ttbar = new Ext.Toolbar({
					items : [{
								...
								scope : this,
								handler : this.check,
								hidden:this.reconciliation
//								hidden : this.openliushuiwin
							}]
				})
