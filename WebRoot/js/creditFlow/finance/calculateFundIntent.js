 ...
 * @company 智维软件
 */ 
calculateFundIntent = Ext.extend(Ext.Window, {
			...
			if(typeof(_cfg.isHiddenbackBtn)!="undefined")
			{
				...
				calculateFundIntent.superclass.constructor.call(this, {
			...
			initUIComponents : function() {
				var objectfinace=this.objectfinace;
				var projectInfoFinance= new calulateFinancePanel({
				...
				var gridPanel = new caluateIntentGrid({
