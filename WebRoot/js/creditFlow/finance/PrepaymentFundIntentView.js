...
PrepaymentFundIntentView= Ext.extend(Ext.Panel, {
	jStore:null,
...
//	fundResource:0,
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		PrepaymentFundIntentView.superclass.constructor.call(this, {
			name : "PrepaymentFundIntentView",
			...
			items : [{
				...
				html : '<br/><B><font class="x-myZW-fieldset-title">【投资人提前还款放款收息表】</font></B>',
	...
	initUIComponents : function() {
		...
		var url=__ctxPath + "/creditFlow/finance/listOfPrepaymentBpFundIntent.do?slEarlyRepaymentId="+this.slEarlyRepaymentId
...
//				fundResource:this.fundResource,
				flag:1
			}
		});
...
//				renderer : investPersonName
	...
	confirmRs : function(){
		...
		if(investPersonName || count>0){*/
			...
			if ((penaltyDays == "" || penaltyDays == null) && penaltyDays!=0) {
					message = "补偿天数";
			}
			...
			this.CusLoanedFundIntentView.autocreate()
