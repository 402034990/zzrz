 ...
 * @createtime:
 */
SlFundIntentOtherPayShould = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentOtherPayShould.superclass.constructor.call(this, {
							id : 'SlFundIntentOtherPayShould',
							title : '应付款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team2',
