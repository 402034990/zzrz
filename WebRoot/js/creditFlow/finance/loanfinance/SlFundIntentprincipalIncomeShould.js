 ...
 * @createtime:
 */
SlFundIntentprincipalIncomeShould = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentprincipalIncomeShould.superclass.constructor.call(this, {
							id : 'SlFundIntentprincipalIncomeShould'+this.businessType+this.type,
							title : '应收款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team2',
...
//						,{xtype:'label',html : '&nbsp;&nbsp已结清项】'}
				...
				this.gridPanel = new HT.GridPanel({
					...
					rowActions : false,
					loadMask : true,
					id : 'SlFundIntentGrid2principalincome',
					isautoLoad:true,
					...
					fields : [{
							...
							'overdueRate', 'accrualMoney', 'status','remark','businessType','projectId','orgName','companyId','interestStarTime','interestEndTime','payintentPeriod','ids','bidPlanId'],
					columns : [{
								header : 'fundIntentId',
