 ...
 * @createtime:
 */
TabSlFundIntentconsultationMoney= Ext.extend(Ext.Panel, {
			// 构造函数
			...
			constructor : function(_cfg) {
				...
				// 调用父类构造
				TabSlFundIntentconsultationMoney.superclass.constructor.call(this, {
							id : 'TabSlFundIntentconsultationMoney'+this.businessType,
							title : '管理咨询费台账',
