 ...
 * @createtime:
 */
SlFundIntentOtherPayOwe = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				SlFundIntentOtherPayOwe.superclass.constructor.call(this, {
							id : 'SlFundIntentOtherPayOwe',
							title : '欠付款项',
							region : 'center',
							layout : 'border',
							iconCls :'btn-team2',
