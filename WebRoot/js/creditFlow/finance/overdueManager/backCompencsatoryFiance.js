 ...
 */
  backCompencsatoryFiance = Ext.extend(Ext.Panel, {
			// 构造函数
			constructor : function(_cfg) {
				...
				// 调用父类构造
				backCompencsatoryFiance.superclass.constructor.call(this, {
							id : 'backCompencsatoryFiance_'+this.planType,
							region : 'center',
							layout : 'border',
			...
			initUIComponents : function() {
               ...
               var labelsize=100;
				...
				this.gridPanel = new HT.GridPanel({
					...
					// 使用RowActions
					rowActions : false,
					id : 'backCompencsatoryFianceGird',
					//isautoLoad:true,
					url : __ctxPath + "/compensatory/listPlBidCompensatory.do?status=2&planType="+this.planType,
	...
	toExcel : function(){
		...
		window.open(__ctxPath + "/compensatory/listBackToExcelPlBidCompensatory.do?status=2"
