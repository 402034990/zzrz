	...
	initUIComponents : function() {
		...
		this.topbar = new Ext.Toolbar({
					items : [{
								...
								xtype : 'button',
								scope : this,
								hidden : isGranted('_createall_b')?false:true,
								...
								xtype : 'button',
								scope : this,
								hidden : isGranted('_createxjls_b')?false:true,
								...
								xtype : 'button',
								scope : this,
								hidden : isGranted('_seexjls_b')?false:true,
								handler : this.seeRs
							} ,new Ext.Toolbar.Separator({
								hidden : (isGranted('_seexjls_b')?false:true)
							}),{
								...
								xtype : 'button',
								scope : this,
								hidden : isGranted('_editxjls_b')?false:true,
								handler : this.editRs
							} ,new Ext.Toolbar.Separator({
								hidden : (isGranted('_editxjls_b')?false:true)||(isGranted('_removexjls_b')?false:true)
							}),{
								iconCls : 'btn-del',
								text : '删除',
								xtype : 'button',
								scope : this,
								hidden : isGranted('_removexjls_b')?false:true,
