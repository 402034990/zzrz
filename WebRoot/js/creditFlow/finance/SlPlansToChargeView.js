...
//				id : 'SlPlansToChargeView',
			...
			tbar : [ {
				...
				iconCls : 'btn-add',
				scope : this,
				hidden : isGranted('_create_zxpz_'+this.businessType)?false:true,
				handler : this.createRs
			}, '-', {
				iconCls : 'btn-del',
				scope : this,
				text : '删除',
				hidden : isGranted('_remove_zxpz_'+this.businessType)?false:true,
				...
				scope : this,
				text : '刷新',
				hidden : isGranted('_flush_zxpz_'+this.businessType)?false:true,
