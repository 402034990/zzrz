 ...
 * @company 智维软件
 */
SlFundIntentForm = Ext.extend(Ext.Window, {
	...
	constructor : function(_cfg) {
		...
		SlFundIntentForm.superclass.constructor.call(this, {
					id : 'SlFundIntentFormWin',
					title : '资金流水',
					region : 'center',
					layout : 'border',
					modal : true,
	...
	initUIComponents : function() {
			...
			items : [{
						...
						listeners : {
							...
							check : function() {
								...
								if (flag == true) {
									Ext.getCmp("qlidetype")
											.setValue("bankqlide");
									Ext
											.getCmp("Q_dialAccounts_S_EQintentqlide")
											.setReadOnly(false);
									Ext
											.getCmp("Q_dialAccounts_S_EQintentqlide")
											.setValue("");
							...
							check : function() {
								...
								if (flag == true) {
									...
									Ext
											...
											.setValue("现金账户");
									Ext
											.getCmp("Q_dialAccounts_S_EQintentqlideid")
											.setValue(null);
									this.search();
								}
							}
		...
		this.gridPanel = new HT.GridPanel({
			...
			tbar : this.topbar,
			url : __ctxPath
					+ "/creditFlow/finance/listSlFundQlide.do?fundType="
					+ this.flag + "&companyId=" + this.companyId,
			fields : [{
						name : 'fundQlideId',
						type : 'int'
	...
	checkRs : function() {
		...
		Ext.MessageBox.confirm('确认', '确定对账吗', function(btn) {
			if (btn == 'yes') {
				Ext.Ajax.request({
							url : __ctxPath
									+ '/creditFlow/finance/checkSlFundIntent.do',
							method : 'POST',
							scope : this,
							params : {
							...
							success : function(response, request) {
								...
								var gridPanel1 = Ext.getCmp('SlFundIntentGrid1'
										+ tabflag);
								var gridPanel2 = Ext.getCmp('SlFundIntentGrid2'
										+ tabflag);
								var gridPanel3 = Ext.getCmp('SlFundIntentGrid3'
										+ tabflag);
								var gridPanel4 = Ext.getCmp('SlFundIntentGrid4'
										+ tabflag);
...
var selectAccountkLinkManintent = function(a, b, c, d, e, f) {
	Ext.getCmp('Q_dialAccounts_S_EQintentqlide')
			.setValue(b + "-" + c + "-" + a);
