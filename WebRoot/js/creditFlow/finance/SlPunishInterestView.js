...
SlPunishInterestView =  Ext.extend(Ext.Window, {
	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			url : __ctxPath + "/creditFlow/finance/listSlPunishInterest.do?fundIntentId="+this.fundIntentId+"&type="+type,
			fields : [{
		...
		openliushuiwin : function() {
			...
			for(var i=0;i<s.length;i++){
				...
				if(notMoney==0){
					Ext.ux.Toast.msg('操作信息', '存在已结清款项,请重新选择!');
					flag=false;
					break;
				}
			}
