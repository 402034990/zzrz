...
SlProcreditAssuretenetedForm = Ext.extend(Ext.Panel, {
	...
	isEditRiskmanageropinionB:true,
	isAutoHeight : true,
	constructor : function(_cfg) {
		...
		if (typeof(_cfg.isEditRiskmanageropinionB) != "undefined") {
			this.isEditRiskmanageropinionB = _cfg.isEditRiskmanageropinionB;
		}
			...
			columns : [
				{
					...
					,
						...
						editor : this.isEditRiskmanagercombox
								? this.comBox
								: null,
						hidden : this.isEditRiskmanageropinionB,
