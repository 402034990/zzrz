				...
				store : new Ext.data.Store({
					proxy : new Ext.data.HttpProxy(
							{//this.ownerCt.ownerCt.ownerCt.ownerCt.PersonCarView.get(0)
								url : __ctxPath+ '/quickenLoan/listCsPersonHouse.do?personId='+ this.personId+"&projecctId="+this.projectId,
								method : "POST"
							}),
...
//							fieldLabel : '产权人',
						    ...
						    store :new Ext.data.SimpleStore({
									fields : ["name", "value"],
									data : [["银行按揭", "银行按揭"],["银行抵押", "银行抵押"],["民间抵押", "民间抵押"],["银行及民间抵押", "银行及民间抵押"]]
							}),
							triggerAction : "all"
						},{
							xtype : 'textfield',
...
//							allowBlank : false,
						...
						items : [{
							xtype:'combo',
							fieldLabel : '房产情况',
							hiddenName : 'csPersonHouse.houseState',
							readOnly  : readOnly,
							width : 120,
							mode : 'local',
						    displayField : 'name',
						...
						items : [{
							xtype:'combo',
							fieldLabel : '购买方式',
							hiddenName : 'csPersonHouse.purchaseType',
							readOnly  : readOnly,
							width : 120,
							mode : 'local',
						    displayField : 'name',
...
//								url : __ctxPath+ '/creditFlow/quickenLoan/listCsPersonCar.do?personId='+ this.personId,
								url : __ctxPath+ '/creditFlow/customer/person/listCsPersonCar.do?personId='+ this.personId+'&projectId='+this.projectId,
								method : "POST"
							}),
					reader : new Ext.data.JsonReader({
						fields : Ext.data.Record.create( [
...
//						labelWidth : 110,
						...
						items : [{
							xtype : 'textfield',
							fieldLabel : '信用情况',
							name : 'csPersonCar.CreditStatus',
							readOnly  : readOnly
						},{
							xtype : 'datefield',
							fieldLabel : '上牌时间',
							name : 'csPersonCar.registrationDate',
							format : 'Y-m-d',
							allowBlank : false,
							readOnly  : readOnly
						}]
						...
						items : [{
							...
							xtype : 'textfield',
							fieldLabel : '使用公里数',
							name : 'csPersonCar.kmDriving',
							readOnly  : readOnly
						},{   
							xtype : 'datefield',
							fieldLabel : '出厂日期',
							name : 'csPersonCar.factoryDate',
							format : 'Y-m-d',
							allowBlank : false,
							readOnly  : readOnly
						}]
...
//						labelWidth : 110,
						...
						items : [{
							...
							fieldLabel : '是否法院执行',
							mode : 'local',
							hiddenName:'csPersonCar.iscourt',
						    displayField : 'name',
						    valueField : 'id',
						    width : 120,
						    readOnly :readOnly,
...
//										__ctxPath + '/creditFlow/quickenLoan/deleteCsPersonCar.do',
										 __ctxPath+ '/creditFlow/customer/person/deleteCsPersonCar.do',
										{
