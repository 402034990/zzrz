							...
							items : [{
								...
								listeners : {
									...
									change  : function(rg,r){
										var linkmanKnown=this.getCmpByName('person.businessLicense')
										    linkmanKnown.setValue(r.inputValue)
									}
								}
							},{
								xtype : 'hidden',
								name : 'person.businessLicense',
								listeners : {
									scope : this,
									loadData : function(com){debugger
										 var ss=this.getCmpByName('person.businessLicense').getValue()
										 var zhizhao=this.getCmpByName('license')
										 if(ss==1){
//										 	zhizhao.items.items[0].checked=true
										 	zhizhao.setValue(1);
//										 	zhizhao.items.items[1].checked=false
										 }else{
										 	zhizhao.setValue(0);
//										 	zhizhao.items.items[0].checked=true
//										 	zhizhao.items.items[1].checked=false
...
//								name:'slSmallloanProject.IsSingle',
								...
								listeners : {
									scope : this,
									change  : function(rg,r){
										var linkmanKnown=this.getCmpByName('person.isSocialCare')
										    linkmanKnown.setValue(r.inputValue)
									}
								}
							},{
								xtype : 'hidden',
								name : 'person.isSocialCare',
								listeners : {
									scope : this,
									loadData : function(com){debugger
										 var linkmanKnown=this.getCmpByName('person.isSocialCare').getValue()
										 var shebao=this.getCmpByName('shebao')
										 if(linkmanKnown=='1'){
										 	shebao.setValue(1);
										 	/*
										 	shebaoka.items[0].checked=true
										 	shebaoka.items[1].checked=false
										 */}else{
										 	shebao.setValue(0);
										 	/*
										 	shebaoka.items[0].checked=false
										 	shebaoka.items[1].checked=true
										 */}
									}
								}
							}]
