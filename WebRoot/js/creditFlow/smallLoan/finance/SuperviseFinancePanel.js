...
SuperviseFinancePanel = Ext.extend(Ext.Panel, {
	...
	constructor : function(_cfg) {
		...
		if(typeof(_cfg.isFirstPage)!="undefined")
		{
		      this.isFirstPage=_cfg.isFirstPage;
		}
			...
			items : [{
				...
				items : [{
					...
					items : [{
						...
						xtype : "textfield",
						fieldLabel : this.isFirstPage==true?"贷款金额":"展期金额",
				...
				columnWidth : 1,
					...
					labelWidth : 85,
					items : [{
								fieldLabel :this.isFirstPage==true?"贷款期数":"展期期数",
								xtype : "textfield",
								fieldClass : 'field-align',
								allowBlank : false,
								readOnly : this.isAllReadOnly,
					...
					labelWidth : 85,
					items : [{
						fieldLabel : this.isFirstPage==true?"贷款开始日期":"展期开始日期",
						xtype : "datefield",
						style : {
							imeMode : 'disabled'
						},
						...
						allowBlank : false,
						readOnly : this.isAllReadOnly,
						blankText :this.isFirstPage==true?"贷款开始日期不能为空，请正确填写!": "展期开始日期不能为空，请正确填写!",
						anchor : "100%",
						format : 'Y-m-d',
					...
					labelWidth : 105,
					items : [{
						fieldLabel :this.isFirstPage==true?"贷款结束日期":"展期结束日期",
						xtype : "datefield",
						style : {
							imeMode : 'disabled'
						},
						...
						readOnly : true,
						allowBlank : false,
						blankText : this.isFirstPage==true?"贷款结束日期不能为空，请正确填写!":"展期结束日期不能为空，请正确填写!",
						anchor : "100%",
						value : this.endDate,
						format : 'Y-m-d'
					}]
					...
					items : [{
						...
						labelAlign : 'right',
						items : [{
							fieldLabel : this.isFirstPage==true?'贷款贷款利率':'展期贷款利率',
							allowBlank : false
						}]
					},{
						columnWidth : .07,
					...
					items : [{
						...
						items : [{
							...
							anchor : "80%",
							scope : this,
							hidden :this.isFirstPage==true?true:this.isHiddenbackBtn,
							handler : function() {
