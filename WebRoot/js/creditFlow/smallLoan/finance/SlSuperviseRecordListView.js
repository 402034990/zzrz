	...
	initUIComponents : function() {
		...
		this.gridPanel = new HT.GridPanel({
			...
			fields : [{
						name : 'id',
						type : 'int'
					}, 'remark','reason','startDate','endDate','continuationMoney','continuationRate'
					,'projectId','accrualtype','payaccrualType','accrualtypeName','payaccrualTypeName'
					,'managementConsultingOfRate','financeServiceOfRate','checkStatus','isPreposePayAccrualsupervise'
					,'opTime','AppUserName','payintentPeriod','overdueRate','yearAccrualRate'],
			columns : [{
						header : 'id',
						dataIndex : 'id',
						hidden : true
