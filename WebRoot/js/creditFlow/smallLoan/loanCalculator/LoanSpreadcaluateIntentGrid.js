...
LoanSpreadcaluateIntentGrid = Ext.extend(Ext.Panel,
				{
					// 构造函数
...
//					  this.businessType="Financing";
						...
						LoanSpreadcaluateIntentGrid.superclass.constructor .call(this, {
							layout:'anchor',
  					        anchor : '100%',
							items : [
								this.gridPanel
...
//								xtype : 'datecolumn',
							...
							listeners : {
								...
								afteredit : function(e) {
									if(e.record.data['fundType'] =='principalLending' || e.record.data['fundType'] =='FinancingInterest' || 
				...
				autocreate : function() { 
					 ...
					 if(this.businessType=="SmallLoan"){  
					 	isActualDay=this.object.getCmpByName("bpProductParameter.isActualDay").getValue();
...
//						'slSmallloanProject.isPreposePayAccrual': isPreposePayAccrual==false?0:1,
