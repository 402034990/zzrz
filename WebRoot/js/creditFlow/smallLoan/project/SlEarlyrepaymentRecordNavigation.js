 ...
 * @extends Ext.Panel
 */
SlEarlyrepaymentRecordNavigation = Ext.extend(Ext.Panel, {
	constructor : function(_cfg) {
		...
		SlEarlyrepaymentRecordNavigation.superclass.constructor.call(this, {
								...
								handler : function() {
									Ext.Ajax.request({
										...
										params : {
											...
											processName : 'repaymentAheadOfTimeFlow'
										},
										method : 'post',
