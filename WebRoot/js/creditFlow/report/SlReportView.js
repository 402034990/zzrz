...
SlReportView = Ext.extend(Ext.Panel, {
	...
	constructor : function(_cfg) {
		...
		if(typeof(_cfg.isShouxin)!='undefined'){
			this.isShouxin = _cfg.isShouxin;
		}else{  
		...
		if(typeof(_cfg.isFaceCheck)!='undefined'){
			this.isFaceCheck= _cfg.isFaceCheck;
		}
		...
		if(typeof(_cfg.businessType)!="undefined") {
	        ...
	        if(this.businessType == 'BankCredit'){
	        	this.templettype =11;
	        	this.ReportTemplate="shouxinhetong";//调查报告模板唯一标识
				this.titleText='申请资料';
				this.setname = '申请资料';
	        }else if(this.businessType == 'SmallLoan'){//业务类别，小贷
				
				this.templettype = 5;
				if(this.isShouxin=="true"){
					this.ReportTemplate="endconfirm";//调查报告模板唯一标识
					this.titleText='结清证明资料确认单';
					this.setname = '结清证明资料确认单';
				}else if(this.isFaceCheck==true){
					this.ReportTemplate="ReportTemplate";//调查报告模板唯一标识
					this.titleText='面审材料清单';
					this.setname = '面审材料清单';
				}else{
					this.ReportTemplate="ReportTemplate";//调查报告模板唯一标识
					this.titleText='付款申请单';
					this.setname = '付款申请单';
				}
			...
			if(this.businessType == 'SmallLoan' && this.Template=="applyreport"){
				this.ReportTemplate="applyreport"
				this.templettype = 11;
				this.titleText='申请表';
				this.setname = '申请表';
			}
	...
	initUIComponents : function() {
		...
		RunNtkOfficePanelForReport = function(projId,businessType,bln,ReportTemplate,templettype){debugger
			Ext.Ajax.request({
...
/*, {
	...
	uploadReportForThisPanel : function(projId,businessType,displayDel,ReportTemplate,templettype,panel,setname,titleText){debugger
