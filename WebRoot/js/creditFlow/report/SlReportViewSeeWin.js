 ...
 * @author Jiang Wanyu
 */
 var SlReportViewSeeWin = function(mark,readOnly,typeisfile,friendLinkId,businessType)
 	{
    ...
    if(typeof(readOnly)!="undefined"){
 	...
 	var url=basepath();
 	url=url+"/creditFlow/fileUploads/getwebPathsFileForm.do";
 	if(typeisfile !=null){
            		...
            		fn: function(dv,index,node,e){
            			...
            			var i=0;
			               ...
			               //img+=record.get('webPath')+',';
			               		img[i]=basepath()+"/"+record.get('webPath');
			                	i++;
			               });
