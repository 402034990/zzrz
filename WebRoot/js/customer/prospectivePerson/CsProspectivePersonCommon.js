	...
	constructor : function(_cfg) {
		...
		customerbaseInfo.superclass.constructor.call(this, {
			...
			items : [{
						 ...
						 * 从上往下的布局 labelWidth :leftlabel, labelAlign : 'right',
						 * hidden : true, items : [{ xtype : 'combo', fieldLabel :
						 * '客户类型', allowBlank : false, hiddenName :
						 * 'bpCustProsperctive.customerType', editable : false,
						 * displayField : 'name', valueField : 'id',
						 * triggerAction : 'all', mode : 'local', readOnly :
						 * this.isRead, autoload : true, store : new
						 * Ext.data.SimpleStore({ fields : ["name", "id"], data :
						 * [["企业", "1"],["个人", "2"]] }), anchor : '100%'
						 *  }] },
						 */{
						...
						items : [{
							...
							// value : personData == null? null:
							// personData.cellphone,
							allowBlank : false,
							anchor : '100%',
							readOnly : this.isRead
/*
 * , regex : /^[1][3578][0-9]{9}$/, regexText : '联系电话1格式不正确', listeners : {
 * scope : this, 'blur' : function(tf){ var telephoneNumber=tf.getValue(); var
 * perId=this.getCmpByName('bpCustProsperctive.perId'); Ext.Ajax.request({ url:
 * __ctxPath +
 * '/creditFlow/customer/customerProsperctive/verificationBpCustProsperctive.do',
 * method : 'POST', params : { telephoneNumber : telephoneNumber,
 * companyId:CompanyId, perId:perId.getValue() }, success :
 * function(response,request) { var
 * obj=Ext.util.JSON.decode(response.responseText); if(!obj.msg){
 * Ext.ux.Toast.msg('操作信息',"该手机号码已存在，请重新输入"); tf.setValue("") } } }); } }
 */
							}]
					}, {
						columnWidth : .3, // 该列在整行中所占的百分比
						...
						items : [{
							...
							listeners : {
								'focus' : function() {
									var obj = this;
									var getEnterAreaObjArray1 = function(
											objArray) {

										obj.setValue(objArray[(objArray.length)
												- 1].text
												+ "_"
										...
										obj
												.nextSibling()
												.setValue(objArray[(objArray.length)
														- 1].id
														+ ","
														+ objArray[(objArray.length)
																- 2].id
						 ...
						 * { columnWidth : .5, // 该列在整行中所占的百分比 layout : "form", //
						 * 从上往下的布局 labelWidth :leftlabel, labelAlign : 'right',
						 * items : [{ xtype : 'numberfield', fieldLabel : '年龄',
						 * anchor : '100%', name : 'bpCustProsperctive.age',
						 * readOnly : this.isRead
						 *  }] },
						 *//*
						 * { columnWidth : .5, // 该列在整行中所占的百分比 layout : "form", //
						 * 从上往下的布局 labelWidth :leftlabel, labelAlign : 'right',
						 * items : [{ xtype : 'numberfield', fieldLabel :
						 * '联系电话2', name :
						 * 'bpCustProsperctive.telephoneNumber2', anchor :
						 * '100%', readOnly : this.isRead, regex :
						 * /^[1][358][0-9]{9}$/, regexText : '联系电话2格式不正确' }] },
						 *//*
							 * { columnWidth : .5, // 该列在整行中所占的百分比 layout :
							 * "form", // 从上往下的布局 labelWidth :leftlabel,
							 * labelAlign : 'right', items : [{ xtype :
							 * 'numberfield', fieldLabel : '固定电话', anchor :
							 * '100%', name :
							 * 'bpCustProsperctive.fixedTelephone', allowBlank :
							 * true, readOnly : this.isRead }] },
							 */{
						 ...
						 * ,{ columnWidth : 1, // 该列在整行中所占的百分比 layout : "form", //
						 * 从上往下的布局 labelWidth :leftlabel, labelAlign : 'right',
						 * items : [{ xtype : "combo", triggerClass :
						 * 'x-form-search-trigger', fieldLabel : "行业类别",
						 * hiddenName : 'bpCustProsperctive.hangyeName', scope :
						 * this, anchor : '100%', editable :false, readOnly :
						 * this.isRead, scope:true,
						 * //value:enterprise==null?null:enterprise.hangyeName,
						 * onTriggerClick : function(e) { var obj = this; var
						 * oobbj=this.nextSibling();
						 * selectTradeCategory(obj,oobbj); } },{
						 * //id:'hangyeType', xtype : "hidden",
		...
		customerbaseInfoLoan.superclass.constructor.call(this, {
			...
			items : [{
						...
						items : [{
							...
							readOnly : this.isRead
								/*
								 * regex : /^[1][3578][0-9]{9}$/, regexText :
								 * '联系电话1格式不正确',
								 */
								/*
								 * listeners : { scope : this, 'blur' :
								 * function(tf){ var
								 * telephoneNumber=tf.getValue(); var
								 * perId=this.getCmpByName('bpCustProsperctive.perId');
								 * Ext.Ajax.request({ url: __ctxPath +
								 * '/creditFlow/customer/customerProsperctive/verificationBpCustProsperctive.do',
								 * method : 'POST', params : { telephoneNumber :
								 * telephoneNumber, companyId:CompanyId,
								 * perId:perId.getValue() }, success :
								 * function(response,request) { var
			...
			constructor : function(_cfg) {
				...
				salesInfo.superclass.constructor.call(this, {
					...
					items : [{
								 ...
								 * { columnWidth:.5, layout: 'form', defaults :
								 * {anchor:anchor}, items :[{ xtype:
								 * 'radiogroup', fieldLabel: '是否有抵质押物', items: [
								 * {boxLabel: '是', disabled : this.isRead, name:
								 * 'bpCustProsperctive.isMortgage', inputValue:
								 * "1",checked:true}, {boxLabel: '否', disabled :
								 * this.isRead, name:
								 * 'bpCustProsperctive.isMortgage', inputValue:
								 * "2",checked:false} ] }] },{ columnWidth : .5,
								 * layout : 'form', labelWidth : leftlabel,
								 * defaults : { anchor : anchor }, items : [{
								 * xtype : 'textfield', hideLabel:true, readOnly :
								 * this.isRead,
	...
	constructor : function(_cfg) {
		...
		InvestSalesInfo.superclass.constructor.call(this, {
			...
			items : [{
						 ...
						 * { columnWidth : .05, // 该列在整行中所占的百分比 layout : "form", //
						 * 从上往下的布局 labelWidth : 20, items : [{ fieldLabel : "元 ",
						 * labelSeparator : '', anchor : "100%" }] },
						 *//*
						 * { columnWidth : .5, // 该列在整行中所占的百分比 layout : "form", //
						 * 从上往下的布局 labelWidth : leftlabel, labelAlign : 'right',
						 * items : [{ xtype:'textfield', fieldLabel : "意向投资产品",
						 * readOnly : this.isRead, anchor : "100%",
						 * name:'bpCustProsperctive.intentionProduct' }] },
						 *//*
						 * { columnWidth : 1, layout : 'form', labelWidth :
						 * leftlabel, items : [{ xtype : 'textfield', fieldLabel :
						 * "投资经验", readOnly : this.isRead, anchor : '100%', name :
						 * 'bpCustProsperctive.investExperience' }] },
						 */{
						columnWidth : .3,
						layout : "form",
						labelWidth : leftlabel,
						...
						items : [{
							...
							store : new Ext.data.SimpleStore({
								...
								// ,name :
								// 'bpCustProsperctive.isHaveinvestExperience'
						}]
					}, {
						columnWidth : .9, // 该列在整行中所占的百分比
						layout : "form", // 从上往下的布局
		...
		this.grid_PersonRelation = new Ext.grid.EditorGridPanel({
			...
			store : new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
					url : __ctxPath
							+ '/creditFlow/customer/customerProsperctiveRelation/listByPerIdBpCustProspectiveRelation.do?perId='
							+ this.perId,
					method : "POST"
				}),
			...
			Ext.Msg.confirm("提示!", '确定要删除吗？', function(btn) {
				if (btn == "yes") {
					...
					if (row.data.relateId == null || row.data.relateId == '') {
						...
						deleteFun(
								__ctxPath
										+ '/creditFlow/customer/customerProsperctiveRelation/multiDelBpCustProspectiveRelation.do',
								{
						...
						items : [{
							...
							listeners : {
								...
								'afterRender' : function(combo) {
									...
									var appuerIdObj = this
											.getCmpByName('bpCustProspectiveFollowup.followPersonId');
