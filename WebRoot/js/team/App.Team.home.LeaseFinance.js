AppHomeTeamLeaseFinance = Ext.extend(Ext.Panel, { 
	...
	constructor : function(_cfg) {
		...
		AppHomeTeamLeaseFinance.superclass.constructor.call(this, {
			title : '融资租赁桌面',
			closable : false,
			id : 'AppHomeTeamLeaseFinance',
			border : false,
			autoScroll : true,
			...
			items : [{
				...
				items : [{
					...
					items : [{
						...
						bodyStyle : 'margin-left:0px;margin-top:5px',
						width : 120,
						html : '<B><font class="x-myZW-fieldset-title">【贷后管理】：</font></B>'
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '还款催收',
						disabled : isGranted('SlFundintentUrgTab?businessType=LeaseFinance')
								? false
								: true,
						iconCls : 'btn-team13',
						scope : this,
						handler : function() {
							App.clickTopTab('SlFundintentUrgTab',{businessType:'LeaseFinance'});
						}
					}]
				},{
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						text : '租后监管',
						disabled : isGranted('LeaseFinanceProjectManagerAfter?managerType=1')
								? false
								: true,
						iconCls : 'btn-team12',
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManagerAfter',{managerType:1});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '贷款展期',
						disabled : isGranted('LeaseFinanceProjectManagerAfter?managerType=2')
								? false
								: true,
						iconCls : 'btn-team14',
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManagerAfter',{managerType:2});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '提前还款',
						disabled : isGranted('LeaseFinanceProjectManagerAfter?managerType=3')
								? false
								: true,
						iconCls : 'btn-team15',
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManagerAfter',{managerType:3});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '利率变更',
						disabled : isGranted('LeaseFinanceProjectManagerAfter?managerType=13')
								? false
								: true,
						iconCls : 'btn-team58',
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManagerAfter',{managerType:13});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '贷款结清',
						disabled : isGranted('LeaseFinanceProjectManagerAfter?managerType=5')
								? false
								: true,
						iconCls : 'btn-team59',
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManagerAfter',{managerType:5});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '违约处理',
						disabled : isGranted('LeaseFinanceProjectManagerAfter?managerType=4')
								? false
								: true,
						iconCls : 'btn-illegal',
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManagerAfter',{managerType:4});
						}
					}]
				}
			]
				...
				items : [{
					...
					items : [{
						...
						bodyStyle : 'margin-left:0px;margin-top:5px',
						width : 120,
						html : '<B><font class="x-myZW-fieldset-title">【贷款查询】：</font></B>'
					}]
				}, {
					layout : "form", // 从上往下的布局
					items : [{
						xtype : 'button',
						text : '全部租赁项目',
						disabled : isGranted('_seeAllPro_fl1000')
								? false
								: true,
						iconCls : 'btn-team16',
						anchor : '100%',
						...
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManager?projectStatus=100&amp;bmStatus=0', {
										projectStatus : 100,
										bmStatus:0
									});
						}
					...
					items : [{
						xtype : 'button',
						text : '办理中租赁项目',
						disabled : isGranted('_seeAllPro_fl00')
								? false
								: true,
						iconCls : 'btn-team17',
						anchor : '100%',
						...
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManager', {
										projectStatus : 0,
										bmStatus:0
									});
						}
					...
					items : [{
						...
						height : btnheigth,
						text : '还款中租赁项目',
						disabled : isGranted('_seeAllPro_fl10')
								? false
								: true,
						iconCls : 'btn-team18',
						scope : this,
					...
					items : [{
						...
						height : btnheigth,
						text : '展期中租赁项目',
						disabled : isGranted('handleExtension')
								? false
								: true,
						iconCls : 'btn-team60',
						scope : this,
						handler : function() {
							App.clickTopTab('LeaseFinanceProjectManagerAfter', {
										managerType : 2
									});
						}
					}]
					...
					items : [{
						...
						text : '违约处理贷款',
						iconCls : 'btn-illegal',
						disabled : isGranted('flstartBreach')
								? false
								: true,
						scope : this,
						handler : function() {
					...
					items : [{
						...
						text : '已完成租赁项目',
						iconCls : 'btn-team19',
						disabled : isGranted('_seeAllPro_fl20')
								? false
								: true,
						scope : this,
						handler : function() {
					...
					items : [{
						...
						text : '提前终止租赁项目',
						iconCls : 'btn-team20',
						disabled : isGranted('_seeAllPro_fl30')
								? false
								: true,
						scope : this,
						handler : function() {
				...
				items : [{
					...
					items : [{
								xtype : 'button',
								text : '供货方客户',
								disabled : isGranted('_see_offerView')==true||isGranted('_create_offerView')==true
										? false
										: true,
								iconCls : 'btn-team21',
								anchor : '100%',
				...
				items : [{
					...
					items : [{
						xtype : 'button',
						text : '本金放款台账',
						disabled : isGranted('TabLeaseFundIntentPrincipalPay?businessType=LeaseFinance&amp;type=rentalCostsPaid')
								? false
								: true,
						iconCls : 'btn-team29',
						anchor : '100%',
						...
						scope : this,
						handler : function() {
							App.clickTopTab('TabLeaseFundIntentPrincipalPay',{
										businessType : 'LeaseFinance',
										type:'rentalCostsPaid'
									});
						}
					}]
				}, {
					...
					items : [{
						...
						iconCls : 'btn-team29',
						text : '租金收取台账',
						disabled : isGranted('TabLeaseFundIntentIncome?businessType=LeaseFinance&amp;type=rental') ? false : true,
						scope : this,
						handler : function() {
							App.clickTopTab('TabLeaseFundIntentIncome', {
										businessType : 'LeaseFinance',
										type:rental
									});
						}
					...
					items : [{
						...
						iconCls : 'btn-team29',
						text : '保证金收取台账',
						disabled : isGranted('TabLeaseFundIntentIncome?businessType=LeaseFinance&amp;type=marginCollection') ? false : true,
						scope : this,
						handler : function() {
							App.clickTopTab('TabLeaseFundIntentIncome', {
										businessType : 'LeaseFinance',
					...
					items : [{
								...
								height : btnheigth,
								text : '保证金退回台账',
								disabled : isGranted('TabLeaseFundIntentPrincipalPay?businessType=LeaseFinance&amp;type=marginRefund')
										? false
										: true,
								iconCls : 'btn-team30',
								scope : this,
					...
					items : [{
						...
						iconCls : 'btn-team28',
						text : '留购费收取台账',
						disabled : isGranted('TabLeaseFundIntentIncome?businessType=LeaseFinance&amp;type=retentionFee')
								? false
								: true,
						scope : this,
						handler : function() {
					...
					items : [{
						...
						iconCls : 'btn-team28',
						text : '手续收入台账',
						disabled : isGranted('SlActualToChargeIncomeView?businessType=LeaseFinance')
								? false
								: true,
						scope : this,
						handler : function() {
							App.clickTopTab('SlActualToChargeIncomeView',{
							businessType:'LeaseFinance'
							});
						}
					}]
				...
				items : [{
					...
					items : [{
						...
						height : btnheigth,
						text : '合同管理',
						disabled : isGranted('ContractManager?businessType=LeaseFinance')
								? false
								: true,
						iconCls : 'btn-team31',
						scope : this,
					...
					items : [{
						...
						height : btnheigth,
						text : '抵质押物管理',
						disabled : isGranted('propertyView?businessType=LeaseFinance')
								? false
								: true,
						iconCls : 'btn-team32',
						scope : this,
						handler : function() {
							App.clickTopTab('MortgageManagement', {
										businessType : 'LeaseFinance'
									});
						}
					}]
					...
					items : [{
						...
						height : btnheigth,
						text : '归档管理',
						disabled : isGranted('PlProjectArchivesView?businessType=LeaseFinance')
								? false
								: true,
						iconCls : 'btn-team33',
						scope : this,
				...
				items : [{
					...
					items : [{
						xtype : 'button',
						text : '合同模板',
						disabled : isGranted('CreditDocumentManager?businessType=LeaseFinance')
								? false
								: true,
						iconCls : 'btn-team47',
						anchor : '100%',
					...
					items : [{
						...
						height : btnheigth,
						text : '文档模板',
						disabled : isGranted('DownLoadDocumentManager?businessType=LeaseFinance')
								? false
								: true,
						iconCls : 'btn-team48',
						scope : this,
					...
					items : [{
						...
						height : btnheigth,
						text : '贷款资料清单',
						disabled : isGranted('OurProcreditMaterialsView')
								? false
								: true,
						iconCls : 'btn-team49',
						scope : this,
						handler : function() {
							App.clickTopTab('OurProcreditMaterialsView');
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '贷款准入原则',
						disabled : isGranted('OurProcreditAssuretenetGuaranteeView?businessType=LeaseFinance')
								? false
								: true,
						iconCls : 'btn-team50',
						scope : this,
						handler : function() {
							App.clickTopTab('OurProcreditAssuretenetLoanView',{
												businessType : 'LeaseFinance'
											});
						}
					}]
