AppHomeTeam = Ext.extend(Ext.Panel, { 
	...
	constructor : function(_cfg) {
		...
		AppHomeTeam.superclass.constructor.call(this, {
			title : '贷款桌面',
			closable : false,
			id : 'AppHomeTeam',
			border : false,
	...
	initUIComponents : function() {
			...
			store : new Ext.data.JsonStore({
				...
				listeners : {
					...
					'load' : function(s, r, o) {
						if (s.getCount() == 0) {
							if(this.getCmpByName('enterprise.enterprisename')){
			...
			items : [{
				...
				items : [{
					...
					items : [{
						...
						height : btnheigth,
						text : '还款催收',
						disabled : isGranted('SlFundintentUrgTab?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team13',
						scope : this,
						handler : function() {
							App.clickTopTab('SlFundintentUrgTab',{businessType:'SmallLoan'});
						}
					}]
				},{
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						text : '贷后监管',
						disabled : isGranted('SmallLoanedProjectManager?managerType=1')
								? false
								: true,
						iconCls : 'btn-team12',
						scope : this,
						handler : function() {
							App.clickTopTab('SmallLoanedProjectManager',{managerType:1});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '贷款展期',
						disabled : isGranted('SmallLoanedProjectManager?managerType=2')
								? false
								: true,
						iconCls : 'btn-team14',
						scope : this,
						handler : function() {
							App.clickTopTab('SmallLoanedProjectManager',{managerType:2});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '提前还款',
						disabled : isGranted('SmallLoanedProjectManager?managerType=3')
								? false
								: true,
						iconCls : 'btn-team15',
						scope : this,
						handler : function() {
							App.clickTopTab('SmallLoanedProjectManager',{managerType:3});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '利率变更',
						disabled : isGranted('SmallLoanedProjectManager?managerType=13')
								? false
								: true,
						iconCls : 'btn-team58',
						scope : this,
						handler : function() {
							App.clickTopTab('SmallLoanedProjectManager',{managerType:13});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '贷款结清',
						disabled : isGranted('SmallLoanedProjectManager?managerType=5')
								? false
								: true,
						iconCls : 'btn-team59',
						scope : this,
						handler : function() {
							App.clickTopTab('SmallLoanedProjectManager',{managerType:5});
						}
					}]
				}, {
					layout : "form", // 从上往下的布局
					...
					items : [{
						...
						height : btnheigth,
						text : '违约处理',
						disabled : isGranted('SmallLoanedProjectManager?managerType=4')
								? false
								: true,
						iconCls : 'btn-illegal',
						scope : this,
						handler : function() {
							App.clickTopTab('SmallLoanedProjectManager',{managerType:4});
						}
					}]
				}
			]
				...
				items : [{
					...
					items : [{
						xtype : 'button',
						text : '全部贷款业务',
						disabled : isGranted('SmallLoanProjectManager?projectStatus=7')
								? false
								: true,
						iconCls : 'btn-team16',
						anchor : '100%',
						...
						scope : this,
						handler : function() {
							App.clickTopTab('SmallLoanProjectManager', {
										projectStatus : 7
									});
						}
					}]
					...
					items : [{
						xtype : 'button',
						text : '办理中贷款',
						disabled : isGranted('SmallLoanProjectManager?projectStatus=0')
								? false
								: true,
						iconCls : 'btn-team17',
						anchor : '100%',
					...
					items : [{
						...
						height : btnheigth,
						text : '放款后贷款',
						disabled : isGranted('SmallLoanProjectManager?projectStatus=1')
								? false
								: true,
						iconCls : 'btn-team18',
						scope : this,
					...
					items : [{
						...
						height : btnheigth,
						text : '展期中贷款',
						disabled : isGranted('SmallLoanProjectManager?projectStatus=5')
								? false
								: true,
						iconCls : 'btn-team60',
						scope : this,
					...
					items : [{
						...
						text : '违约处理贷款',
						iconCls : 'btn-illegal',
						disabled : isGranted('SmallLoanProjectManager?projectStatus=8')
								? false
								: true,
						scope : this,
						handler : function() {
					...
					items : [{
						...
						text : '已完成贷款',
						iconCls : 'btn-team19',
						disabled : isGranted('SmallLoanProjectManager?projectStatus=2')
								? false
								: true,
						scope : this,
						handler : function() {
					...
					items : [{
						...
						text : '提前终止贷款',
						iconCls : 'btn-team20',
						disabled : isGranted('SmallLoanProjectManager?projectStatus=3')
								? false
								: true,
						scope : this,
						handler : function() {
				...
				items : [{
					...
					items : [{
						xtype : 'button',
						text : '本金放款台账',
						disabled : isGranted('TabSlFundIntentPrincipalPay?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team29',
						anchor : '100%',
					...
					items : [{
						...
						iconCls : 'btn-team29',
						text : '本金收款台账',
						disabled : isGranted('TabSlFundIntentprincipalIncome?businessType=SmallLoan') ? false : true,
						scope : this,
						handler : function() {
					...
					items : [{
						...
						iconCls : 'btn-team29',
						text : '利息收款台账',
						disabled : isGranted('TabSlFundIntentInterestIncome?businessType=SmallLoan') ? false : true,
						scope : this,
						handler : function() {
					...
					items : [{
								...
								height : btnheigth,
								text : '手续收入台账',
								disabled : isGranted('SlActualToChargeIncomeView?businessType=all')
										? false
										: true,
								iconCls : 'btn-team30',
								scope : this,
				...
				items : [{
					...
					items : [{
						...
						height : btnheigth,
						text : '合同管理',
						disabled : isGranted('ContractManager?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team31',
						scope : this,
					...
					items : [{
						...
						height : btnheigth,
						text : '抵质押物管理',
						disabled : isGranted('propertyView?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team32',
						scope : this,
					...
					items : [{
						...
						height : btnheigth,
						text : '归档管理',
						disabled : isGranted('PlProjectArchivesView?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team33',
						scope : this,
				...
				items : [{
					...
					items : [{
						xtype : 'button',
						text : '合同模板',
						disabled : isGranted('CreditDocumentManager?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team47',
						anchor : '100%',
					...
					items : [{
						...
						height : btnheigth,
						text : '文档模板',
						disabled : isGranted('DownLoadDocumentManager?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team48',
						scope : this,
					...
					items : [{
						...
						height : btnheigth,
						text : '贷款准入原则',
						disabled : isGranted('OurProcreditAssuretenetGuaranteeView?businessType=SmallLoan')
								? false
								: true,
						iconCls : 'btn-team50',
						scope : this,
