...
<html xmlns="http://www.w3.org/1999/xhtml">
        							...
        							url:'<%=request.getContextPath()%>'+"/ajaxValidation.do",
          							...
          							success:function(response,opts){
          							     ...
          							     if(!isFalg){
          							         ...
          							         document.getElementById("passwrodError").innerHTML="";
          							         document.getElementById("loginCodeError").innerHTML="";
          							         document.getElementById(errorType).innerHTML=msg;
          							         refeshCode();
        ...
        <div class="loginleft">
            ...
            <div class="login_c_d">
                <form id="loginForm"  method="post"  onsubmit="return checkform()"  accept-charset="utf-8">
                    ...
                    <p>
	                    <input id="username" class="input_text input-icon" type="text" name="username" placeholder="用户名" / >
	                    <em class="one"></em>
	                    <span id="userNameError" style="color:red">${FieldErrors.username[0]}</span>
                    </p>
                    <p>
                    	<input id="password" class="input_text input-icon" type="password" name="password"  id="password" placeholder="密码" />
                    	<em class="two"></em>
    ...
    <!-- <div class="text">北京互融时代软件有限公司© 2016</div> -->
</div>
