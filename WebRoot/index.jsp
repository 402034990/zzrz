...
<head>
		...
		<script type="text/javascript" src="<%=basePath%>/js/creditFlow/smallLoan/loanCalculator/LoanSpreadcalculateFundIntent.js"></script>
	 	<script type="text/javascript" src="<%=basePath%>/js/creditFlow/smallLoan/loanCalculator/LoanSpreadcaluateIntentGrid.js"></script>
	 	<script type="text/javascript" src="<%=basePath%>/js/creditFlow/smallLoan/loanCalculator/LoanSpreadcalulateFinancePanel.js"></script>
	 	<script type="text/javascript" src="<%=basePath%>/js/creditFlow/smallLoan/loanCalculator/LoanSpreadcalulateloadDataCommon.js"></script>
	...
	<body oncontextmenu="return false">
        <div class="header" id="app-header">
			...
			<div class="header_right">
        		<!--<div class="welcome">
	        		<span>您好，<a href="#" class="top_ctrl"  onclick="changeCurrentUser()"  style="color:black; cursor:pointer; text-decoration:underline"><security:authentication property="principal.fullname"/>!</a></span>&nbsp;&nbsp;
	        		<span  style=" cursor:pointer; text-decoration:underline" onclick = "App.Logout()" >退出登录</span>&nbsp;&nbsp;
	        		...
	        		<span  style=" cursor:pointer; text-decoration:underline" onclick = "App.clickTopTab('PersonalDesktop')" >我的工作台</span>
	        	</div>
				--><div class="header_rit">
					...
					<%}%>
					<div class="operating">
						<a href="#"  class="myFlow"  onclick="App.ClickTaskCount()" ><div class="do" id="taskCount">0</div>待办任务</a>
					</div>
					
					<div class="operating" id="customerManger">
						<a href="#" class="customerManger"  onclick="customerManger()" >客户中心</a>
					</div>
					<div class="operating" id="smallHandler">
						<a href="#" class="smallHandler"  onclick="smallHandler()" >贷款业务</a>
					</div>
					<!--  <div class="operating" id="faManger">
						<a href="#" class="faManger"  onclick="showNewMenus(this,'fa')">网贷业务</a> 
					</div>
					<div class="operating" id="p2pManger" >
						<a href="#" class="p2pManger"  onclick="p2pManger()" >运营中心</a>
					</div>
					-->
					<div class="operating" id="controlManger" >
						<a href="#" class="controlManger"  onclick="controlManger()" >风控中心</a>
					</div><!--
					<div class="operating" id="reportManger" >
						<a href="#" class="reportManger"  onclick="reportManger()" >台账报表</a>
					</div>
					--><!--<div class="operating" id="DKManger">
						<a href="#" class="faManger"  onclick="CustomerToolBox()" >客户查询器</a>
					</div>-->
					<!--
					<div class="operating">
	...
	<script type="text/javascript">
	     ...
	     var controlMoney="<%=AppUtil.getControlMoney()%>"
